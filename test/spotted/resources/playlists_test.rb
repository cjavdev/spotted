  ...
  def test_retrieve
    ...
    assert_pattern do
      response => {
        ...
        external_urls: Spotted::Models::PlaylistRetrieveResponse::ExternalURLs | nil,
        href: String | nil,
        images: ^(Spotted::Internal::Type::ArrayOf[Spotted::Models::PlaylistRetrieveResponse::Image]) | nil,
        name: String | nil,
