...
class Spotted::Test::PrimitiveModelTest < Minitest::Test
  A = Spotted::Internal::Type::ArrayOf[-> { Integer }]
  H = Spotted::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < Spotted::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Spotted::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Spotted::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Spotted::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Spotted::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Spotted::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Spotted::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Spotted::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Spotted::Internal::Type::Boolean, true] => true,
      [Spotted::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Spotted::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Spotted::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Spotted::Internal::Type::Converter.new_coerce_state
      Spotted::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Spotted::Internal::Type::Converter.dump(target, input, state: state)
...
class Spotted::Test::EnumModelTest < Minitest::Test
  class E0
    include Spotted::Internal::Type::Enum
...
class Spotted::Test::CollectionModelTest < Minitest::Test
  A1 = Spotted::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Spotted::Internal::Type::HashOf[Integer]

  A2 = Spotted::Internal::Type::ArrayOf[H1]
  H2 = Spotted::Internal::Type::HashOf[-> { A1 }]

  A3 = Spotted::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Spotted::Internal::Type::HashOf[Integer, nil?: true]
...
class Spotted::Test::BaseModelTest < Minitest::Test
  class M1 < Spotted::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Spotted::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Spotted::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Spotted::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Spotted::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Spotted::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Spotted::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Spotted::Errors::ConversionError => e
...
class Spotted::Test::UnionTest < Minitest::Test
  class U0
    include Spotted::Internal::Type::Union
  ...
  class M2 < Spotted::Internal::Type::BaseModel
  ...
  class M4 < Spotted::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Spotted::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Spotted::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Spotted::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Spotted::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Spotted::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [Spotted::Internal::Type::Unknown, Spotted::Internal::Type::Unknown] => true,
      [Spotted::Internal::Type::Boolean, Spotted::Internal::Type::Boolean] => true,
      [Spotted::Internal::Type::Unknown, Spotted::Internal::Type::Boolean] => false,
...
class Spotted::Test::MetaInfoTest < Minitest::Test
  A1 = Spotted::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Spotted::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
