...
module Spotted
  module Models
    ...
    class BrowseGetFeaturedPlaylistsResponse < Spotted::Internal::Type::BaseModel
      ...
      # @!attribute playlists
      #
      #   @return [Spotted::Models::BrowseGetFeaturedPlaylistsResponse::Playlists, nil]
      optional :playlists, -> { Spotted::Models::BrowseGetFeaturedPlaylistsResponse::Playlists }
      ...
      #
      #   @param playlists [Spotted::Models::BrowseGetFeaturedPlaylistsResponse::Playlists]

      # @see Spotted::Models::BrowseGetFeaturedPlaylistsResponse#playlists
      class Playlists < Spotted::Internal::Type::BaseModel
        ...
        # @!attribute items
        #
        #   @return [Array<Spotted::Models::BrowseGetFeaturedPlaylistsResponse::Playlists::Item>]
        required :items,
                 -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::BrowseGetFeaturedPlaylistsResponse::Playlists::Item] }
        ...
        #   Some parameter documentations has been truncated, see
        #   {Spotted::Models::BrowseGetFeaturedPlaylistsResponse::Playlists} for more
        #   details.
        #
        #   @param href [String] A link to the Web API endpoint returning the full result of the request
        #
        #   @param items [Array<Spotted::Models::BrowseGetFeaturedPlaylistsResponse::Playlists::Item>]
        #
        ...
        class Item < Spotted::Internal::Type::BaseModel
          ...
          #
          #   @return [Spotted::Models::BrowseGetFeaturedPlaylistsResponse::Playlists::Item::ExternalURLs, nil]
          ...
          #
          #   @return [Array<Spotted::Models::BrowseGetFeaturedPlaylistsResponse::Playlists::Item::Image>, nil]
          optional :images,
                   -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::BrowseGetFeaturedPlaylistsResponse::Playlists::Item::Image] }
          ...
          #
          #   @return [Spotted::Models::BrowseGetFeaturedPlaylistsResponse::Playlists::Item::Owner, nil]
          optional :owner, -> { Spotted::Models::BrowseGetFeaturedPlaylistsResponse::Playlists::Item::Owner }
          ...
          #
          #   @return [Spotted::Models::BrowseGetFeaturedPlaylistsResponse::Playlists::Item::Tracks, nil]
          optional :tracks, -> { Spotted::Models::BrowseGetFeaturedPlaylistsResponse::Playlists::Item::Tracks }
          ...
          #   Some parameter documentations has been truncated, see
          #   {Spotted::Models::BrowseGetFeaturedPlaylistsResponse::Playlists::Item} for more
          #   details.
          #
          ...
          #   other
          #
          #   @param external_urls [Spotted::Models::BrowseGetFeaturedPlaylistsResponse::Playlists::Item::ExternalURLs] Known external URLs for this playlist.
          #
          #   @param href [String] A link to the Web API endpoint providing full details of the playlist.
          #
          #   @param images [Array<Spotted::Models::BrowseGetFeaturedPlaylistsResponse::Playlists::Item::Image>] Images for the playlist. The array may be empty or contain up to three images. T
          #
          #   @param name [String] The name of the playlist.
          #
          #   @param owner [Spotted::Models::BrowseGetFeaturedPlaylistsResponse::Playlists::Item::Owner] The user who owns the playlist
          #
          ...
          #
          #   @param tracks [Spotted::Models::BrowseGetFeaturedPlaylistsResponse::Playlists::Item::Tracks] A collection containing a link ( `href` ) to the Web API endpoint where full det
          #
          ...
          # @see Spotted::Models::BrowseGetFeaturedPlaylistsResponse::Playlists::Item#external_urls
          ...
          # @see Spotted::Models::BrowseGetFeaturedPlaylistsResponse::Playlists::Item#owner
          class Owner < Spotted::Internal::Type::BaseModel
            ...
            #
            #   @return [Spotted::Models::BrowseGetFeaturedPlaylistsResponse::Playlists::Item::Owner::ExternalURLs, nil]
            optional :external_urls,
            ...
            #   The object type.
            #
            #   @return [Symbol, Spotted::Models::BrowseGetFeaturedPlaylistsResponse::Playlists::Item::Owner::Type, nil]
            optional :type,
                     enum: -> { Spotted::Models::BrowseGetFeaturedPlaylistsResponse::Playlists::Item::Owner::Type }
            ...
            #
            #   @param external_urls [Spotted::Models::BrowseGetFeaturedPlaylistsResponse::Playlists::Item::Owner::ExternalURLs] Known public external URLs for this user.
            #
            #   @param href [String] A link to the Web API endpoint for this user.
            #
            #   @param type [Symbol, Spotted::Models::BrowseGetFeaturedPlaylistsResponse::Playlists::Item::Owner::Type] The object type.
            #
            #   @param uri [String] The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for this use

            # @see Spotted::Models::BrowseGetFeaturedPlaylistsResponse::Playlists::Item::Owner#external_urls
            class ExternalURLs < Spotted::Internal::Type::BaseModel
              # @!attribute spotify
              #   The [Spotify URL](/documentation/web-api/concepts/spotify-uris-ids) for the
              #   object.
            ...
            # The object type.
            #
            # @see Spotted::Models::BrowseGetFeaturedPlaylistsResponse::Playlists::Item::Owner#type
            module Type
          ...
          # @see Spotted::Models::BrowseGetFeaturedPlaylistsResponse::Playlists::Item#tracks
