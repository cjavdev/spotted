...
module Spotted
  module Models
    # @see Spotted::Resources::Tracks#retrieve
    class TrackRetrieveResponse < Spotted::Internal::Type::BaseModel
      ...
      #
      #   @return [Spotted::Models::TrackRetrieveResponse::Album, nil]
      optional :album, -> { Spotted::Models::TrackRetrieveResponse::Album }

      # @!attribute artists
      #   The artists who performed the track. Each artist object includes a link in
      #   `href` to more detailed information about the artist.
      #
      #   @return [Array<Spotted::Models::TrackRetrieveResponse::Artist>, nil]
      optional :artists, -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::TrackRetrieveResponse::Artist] }
      ...
      #
      #   @return [Spotted::Models::TrackRetrieveResponse::ExternalIDs, nil]
      optional :external_ids, -> { Spotted::Models::TrackRetrieveResponse::ExternalIDs }

      # @!attribute external_urls
      #   Known external URLs for this track.
      #
      #   @return [Spotted::Models::TrackRetrieveResponse::ExternalURLs, nil]
      optional :external_urls, -> { Spotted::Models::TrackRetrieveResponse::ExternalURLs }
      ...
      #
      #   @return [Spotted::Models::TrackRetrieveResponse::Restrictions, nil]
      optional :restrictions, -> { Spotted::Models::TrackRetrieveResponse::Restrictions }
      ...
      #
      #   @return [Symbol, Spotted::Models::TrackRetrieveResponse::Type, nil]
      optional :type, enum: -> { Spotted::Models::TrackRetrieveResponse::Type }
      ...
      #   {Spotted::Models::TrackRetrieveResponse} for more details.
      #
      #   @param id [String] The [Spotify ID](/documentation/web-api/concepts/spotify-uris-ids) for the track
      #
      #   @param album [Spotted::Models::TrackRetrieveResponse::Album] The album on which the track appears. The album object includes a link in `href`
      #
      #   @param artists [Array<Spotted::Models::TrackRetrieveResponse::Artist>] The artists who performed the track. Each artist object includes a link in `href
      #
      ...
      #
      #   @param external_ids [Spotted::Models::TrackRetrieveResponse::ExternalIDs] Known external IDs for the track.
      #
      #   @param external_urls [Spotted::Models::TrackRetrieveResponse::ExternalURLs] Known external URLs for this track.
      #
      ...
      #
      #   @param restrictions [Spotted::Models::TrackRetrieveResponse::Restrictions] Included in the response when a content restriction is applied.
      #
      #   @param track_number [Integer] The number of the track. If an album has several discs, the track number is the
      #
      #   @param type [Symbol, Spotted::Models::TrackRetrieveResponse::Type] The object type: "track".
      #
      #   @param uri [String] The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for the trac

      # @see Spotted::Models::TrackRetrieveResponse#album
      class Album < Spotted::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Spotted::Models::TrackRetrieveResponse::Album::AlbumType]
        required :album_type, enum: -> { Spotted::Models::TrackRetrieveResponse::Album::AlbumType }

        # @!attribute artists
        #   The artists of the album. Each artist object includes a link in `href` to more
        #   detailed information about the artist.
        #
        #   @return [Array<Spotted::Models::TrackRetrieveResponse::Album::Artist>]
        required :artists,
                 -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::TrackRetrieveResponse::Album::Artist] }
        ...
        #
        #   @return [Spotted::Models::TrackRetrieveResponse::Album::ExternalURLs]
        required :external_urls, -> { Spotted::Models::TrackRetrieveResponse::Album::ExternalURLs }
        ...
        #
        #   @return [Array<Spotted::Models::TrackRetrieveResponse::Album::Image>]
        required :images,
                 -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::TrackRetrieveResponse::Album::Image] }
        ...
        #
        #   @return [Symbol, Spotted::Models::TrackRetrieveResponse::Album::ReleaseDatePrecision]
        required :release_date_precision,
                 enum: -> { Spotted::Models::TrackRetrieveResponse::Album::ReleaseDatePrecision }
        ...
        #   The object type.
        #
        #   @return [Symbol, Spotted::Models::TrackRetrieveResponse::Album::Type]
        required :type, enum: -> { Spotted::Models::TrackRetrieveResponse::Album::Type }
        ...
        #   Included in the response when a content restriction is applied.
        #
        #   @return [Spotted::Models::TrackRetrieveResponse::Album::Restrictions, nil]
        optional :restrictions, -> { Spotted::Models::TrackRetrieveResponse::Album::Restrictions }
        ...
        #   Some parameter documentations has been truncated, see
        #   {Spotted::Models::TrackRetrieveResponse::Album} for more details.
        #
        #   The album on which the track appears. The album object includes a link in `href`
        #   to full information about the album.
        #
        ...
        #
        #   @param album_type [Symbol, Spotted::Models::TrackRetrieveResponse::Album::AlbumType] The type of the album.
        #
        #   @param artists [Array<Spotted::Models::TrackRetrieveResponse::Album::Artist>] The artists of the album. Each artist object includes a link in `href` to more d
        #
        #   @param available_markets [Array<String>] The markets in which the album is available: [ISO 3166-1 alpha-2 country codes](
        #
        #   @param external_urls [Spotted::Models::TrackRetrieveResponse::Album::ExternalURLs] Known external URLs for this album.
        #
        #   @param href [String] A link to the Web API endpoint providing full details of the album.
        #
        #   @param images [Array<Spotted::Models::TrackRetrieveResponse::Album::Image>] The cover art for the album in various sizes, widest first.
        #
        ...
        #
        #   @param release_date_precision [Symbol, Spotted::Models::TrackRetrieveResponse::Album::ReleaseDatePrecision] The precision with which `release_date` value is known.
        #
        #   @param total_tracks [Integer] The number of tracks in the album.
        #
        #   @param type [Symbol, Spotted::Models::TrackRetrieveResponse::Album::Type] The object type.
        #
        #   @param uri [String] The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for the albu
        #
        #   @param restrictions [Spotted::Models::TrackRetrieveResponse::Album::Restrictions] Included in the response when a content restriction is applied.

        # The type of the album.
        #
        # @see Spotted::Models::TrackRetrieveResponse::Album#album_type
        module AlbumType
        ...
        class Artist < Spotted::Internal::Type::BaseModel
          ...
          #
          #   @return [Spotted::Models::TrackRetrieveResponse::Album::Artist::ExternalURLs, nil]
          optional :external_urls, -> { Spotted::Models::TrackRetrieveResponse::Album::Artist::ExternalURLs }
          ...
          #   The object type.
          #
          #   @return [Symbol, Spotted::Models::TrackRetrieveResponse::Album::Artist::Type, nil]
          optional :type, enum: -> { Spotted::Models::TrackRetrieveResponse::Album::Artist::Type }
          ...
          #   Some parameter documentations has been truncated, see
          #   {Spotted::Models::TrackRetrieveResponse::Album::Artist} for more details.
          #
          #   @param id [String] The [Spotify ID](/documentation/web-api/concepts/spotify-uris-ids) for the artis
          #
          #   @param external_urls [Spotted::Models::TrackRetrieveResponse::Album::Artist::ExternalURLs] Known external URLs for this artist.
          #
          ...
          #
          #   @param type [Symbol, Spotted::Models::TrackRetrieveResponse::Album::Artist::Type] The object type.
          #
          #   @param uri [String] The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for the arti

          # @see Spotted::Models::TrackRetrieveResponse::Album::Artist#external_urls
          class ExternalURLs < Spotted::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {Spotted::Models::TrackRetrieveResponse::Album::Artist::ExternalURLs} for more
            #   details.
            #
            #   Known external URLs for this artist.
            #
          ...
          # The object type.
          #
          # @see Spotted::Models::TrackRetrieveResponse::Album::Artist#type
          module Type
            extend Spotted::Internal::Type::Enum
        ...
        # @see Spotted::Models::TrackRetrieveResponse::Album#external_urls
        class ExternalURLs < Spotted::Internal::Type::BaseModel
          # @!attribute spotify
          #   The [Spotify URL](/documentation/web-api/concepts/spotify-uris-ids) for the
          #   object.
          ...
          # @!method initialize(spotify: nil)
          #   Some parameter documentations has been truncated, see
          #   {Spotted::Models::TrackRetrieveResponse::Album::ExternalURLs} for more details.
          #
          #   Known external URLs for this album.
          #
          #   @param spotify [String] The [Spotify URL](/documentation/web-api/concepts/spotify-uris-ids) for the obje
        ...
        class Image < Spotted::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Spotted::Models::TrackRetrieveResponse::Album::Image} for more details.
          #
        ...
        # The precision with which `release_date` value is known.
        #
        # @see Spotted::Models::TrackRetrieveResponse::Album#release_date_precision
        ...
        # The object type.
        #
        # @see Spotted::Models::TrackRetrieveResponse::Album#type
        module Type
          extend Spotted::Internal::Type::Enum
        ...
        # @see Spotted::Models::TrackRetrieveResponse::Album#restrictions
        class Restrictions < Spotted::Internal::Type::BaseModel
          ...
          #   the future.
          #
          #   @return [Symbol, Spotted::Models::TrackRetrieveResponse::Album::Restrictions::Reason, nil]
          optional :reason, enum: -> { Spotted::Models::TrackRetrieveResponse::Album::Restrictions::Reason }

          # @!method initialize(reason: nil)
          #   Some parameter documentations has been truncated, see
          #   {Spotted::Models::TrackRetrieveResponse::Album::Restrictions} for more details.
          #
          #   Included in the response when a content restriction is applied.
          #
          #   @param reason [Symbol, Spotted::Models::TrackRetrieveResponse::Album::Restrictions::Reason] The reason for the restriction. Albums may be restricted if the content is not a
          ...
          # the future.
          #
          # @see Spotted::Models::TrackRetrieveResponse::Album::Restrictions#reason
          module Reason
            extend Spotted::Internal::Type::Enum
      ...
      class Artist < Spotted::Internal::Type::BaseModel
        ...
        #   Known external URLs for this artist.
        #
        #   @return [Spotted::Models::TrackRetrieveResponse::Artist::ExternalURLs, nil]
        optional :external_urls, -> { Spotted::Models::TrackRetrieveResponse::Artist::ExternalURLs }
        ...
        #   The object type.
        #
        #   @return [Symbol, Spotted::Models::TrackRetrieveResponse::Artist::Type, nil]
        optional :type, enum: -> { Spotted::Models::TrackRetrieveResponse::Artist::Type }
        ...
        # @!method initialize(id: nil, external_urls: nil, href: nil, name: nil, type: nil, uri: nil)
        #   Some parameter documentations has been truncated, see
        #   {Spotted::Models::TrackRetrieveResponse::Artist} for more details.
        #
        #   @param id [String] The [Spotify ID](/documentation/web-api/concepts/spotify-uris-ids) for the artis
        #
        #   @param external_urls [Spotted::Models::TrackRetrieveResponse::Artist::ExternalURLs] Known external URLs for this artist.
        #
        #   @param href [String] A link to the Web API endpoint providing full details of the artist.
        #
        #   @param name [String] The name of the artist.
        #
        #   @param type [Symbol, Spotted::Models::TrackRetrieveResponse::Artist::Type] The object type.
        #
        #   @param uri [String] The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for the arti

        # @see Spotted::Models::TrackRetrieveResponse::Artist#external_urls
        class ExternalURLs < Spotted::Internal::Type::BaseModel
          # @!attribute spotify
          #   The [Spotify URL](/documentation/web-api/concepts/spotify-uris-ids) for the
          #   object.
          ...
          # @!method initialize(spotify: nil)
          #   Some parameter documentations has been truncated, see
          #   {Spotted::Models::TrackRetrieveResponse::Artist::ExternalURLs} for more details.
          #
          #   Known external URLs for this artist.
          #
          #   @param spotify [String] The [Spotify URL](/documentation/web-api/concepts/spotify-uris-ids) for the obje
        ...
        # The object type.
        #
        # @see Spotted::Models::TrackRetrieveResponse::Artist#type
        module Type
          extend Spotted::Internal::Type::Enum
      ...
      # @see Spotted::Models::TrackRetrieveResponse#external_ids
      class ExternalIDs < Spotted::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {Spotted::Models::TrackRetrieveResponse::ExternalIDs} for more details.
        #
        #   Known external IDs for the track.
        #
      ...
      # @see Spotted::Models::TrackRetrieveResponse#external_urls
      class ExternalURLs < Spotted::Internal::Type::BaseModel
        # @!attribute spotify
        #   The [Spotify URL](/documentation/web-api/concepts/spotify-uris-ids) for the
        #   object.
        ...
        # @!method initialize(spotify: nil)
        #   Some parameter documentations has been truncated, see
        #   {Spotted::Models::TrackRetrieveResponse::ExternalURLs} for more details.
        #
        #   Known external URLs for this track.
        #
        #   @param spotify [String] The [Spotify URL](/documentation/web-api/concepts/spotify-uris-ids) for the obje
      ...
      # @see Spotted::Models::TrackRetrieveResponse#restrictions
      class Restrictions < Spotted::Internal::Type::BaseModel
        # @!attribute reason
        ...
        # @!method initialize(reason: nil)
        #   Some parameter documentations has been truncated, see
        #   {Spotted::Models::TrackRetrieveResponse::Restrictions} for more details.
        #
        #   Included in the response when a content restriction is applied.
        #
      ...
      # The object type: "track".
      #
      # @see Spotted::Models::TrackRetrieveResponse#type
      module Type
        extend Spotted::Internal::Type::Enum
