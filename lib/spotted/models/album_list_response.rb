  ...
  module Models
    ...
    class AlbumListResponse < Spotted::Internal::Type::BaseModel
      ...
      class Album < Spotted::Internal::Type::BaseModel
        ...
        #
        #   @return [Spotted::Models::AlbumListResponse::Album::ExternalURLs]
        required :external_urls, -> { Spotted::Models::AlbumListResponse::Album::ExternalURLs }
        ...
        #
        #   @return [Array<Spotted::Models::AlbumListResponse::Album::Image>]
        required :images,
                 -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::AlbumListResponse::Album::Image] }
        ...
        #
        #   @return [Array<Spotted::Models::AlbumListResponse::Album::Artist>, nil]
        optional :artists,
                 -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::AlbumListResponse::Album::Artist] }

        # @!attribute copyrights
        #   The copyright statements of the album.
        #
        #   @return [Array<Spotted::Models::AlbumListResponse::Album::Copyright>, nil]
        optional :copyrights,
                 -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::AlbumListResponse::Album::Copyright] }

        # @!attribute external_ids
        #   Known external IDs for the album.
        #
        #   @return [Spotted::Models::AlbumListResponse::Album::ExternalIDs, nil]
        optional :external_ids, -> { Spotted::Models::AlbumListResponse::Album::ExternalIDs }
        ...
        #
        #   @return [Spotted::Models::AlbumListResponse::Album::Restrictions, nil]
        optional :restrictions, -> { Spotted::Models::AlbumListResponse::Album::Restrictions }
        ...
        #
        #   @param external_urls [Spotted::Models::AlbumListResponse::Album::ExternalURLs] Known external URLs for this album.
        #
        #   @param href [String] A link to the Web API endpoint providing full details of the album.
        #
        #   @param images [Array<Spotted::Models::AlbumListResponse::Album::Image>] The cover art for the album in various sizes, widest first.
        #
        ...
        #
        #   @param artists [Array<Spotted::Models::AlbumListResponse::Album::Artist>] The artists of the album. Each artist object includes a link in `href` to more d
        #
        #   @param copyrights [Array<Spotted::Models::AlbumListResponse::Album::Copyright>] The copyright statements of the album.
        #
        #   @param external_ids [Spotted::Models::AlbumListResponse::Album::ExternalIDs] Known external IDs for the album.
        #
        ...
        #
        #   @param restrictions [Spotted::Models::AlbumListResponse::Album::Restrictions] Included in the response when a content restriction is applied.
        #
        ...
        # @see Spotted::Models::AlbumListResponse::Album#external_urls
        class ExternalURLs < Spotted::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Spotted::Models::AlbumListResponse::Album::ExternalURLs} for more details.
          #
          #   Known external URLs for this album.
          #
        ...
        class Image < Spotted::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Spotted::Models::AlbumListResponse::Album::Image} for more details.
          #
        ...
        class Artist < Spotted::Internal::Type::BaseModel
          ...
          #
          #   @return [Spotted::Models::AlbumListResponse::Album::Artist::ExternalURLs, nil]
          optional :external_urls, -> { Spotted::Models::AlbumListResponse::Album::Artist::ExternalURLs }
          ...
          #   The object type.
          #
          #   @return [Symbol, Spotted::Models::AlbumListResponse::Album::Artist::Type, nil]
          optional :type, enum: -> { Spotted::Models::AlbumListResponse::Album::Artist::Type }
          ...
          #   Some parameter documentations has been truncated, see
          #   {Spotted::Models::AlbumListResponse::Album::Artist} for more details.
          #
          #   @param id [String] The [Spotify ID](/documentation/web-api/concepts/spotify-uris-ids) for the artis
          #
          #   @param external_urls [Spotted::Models::AlbumListResponse::Album::Artist::ExternalURLs] Known external URLs for this artist.
          #
          ...
          #
          #   @param type [Symbol, Spotted::Models::AlbumListResponse::Album::Artist::Type] The object type.
          #
          #   @param uri [String] The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for the arti

          # @see Spotted::Models::AlbumListResponse::Album::Artist#external_urls
          class ExternalURLs < Spotted::Internal::Type::BaseModel
            # @!attribute spotify
            #   The [Spotify URL](/documentation/web-api/concepts/spotify-uris-ids) for the
            #   object.
            ...
            # @!method initialize(spotify: nil)
            #   Some parameter documentations has been truncated, see
            #   {Spotted::Models::AlbumListResponse::Album::Artist::ExternalURLs} for more
            #   details.
            #
            #   Known external URLs for this artist.
            #
          ...
          # The object type.
          #
          # @see Spotted::Models::AlbumListResponse::Album::Artist#type
          module Type
            extend Spotted::Internal::Type::Enum
        ...
        class Copyright < Spotted::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Spotted::Models::AlbumListResponse::Album::Copyright} for more details.
          #
        ...
        # @see Spotted::Models::AlbumListResponse::Album#external_ids
        class ExternalIDs < Spotted::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Spotted::Models::AlbumListResponse::Album::ExternalIDs} for more details.
          #
          #   Known external IDs for the album.
          #
        ...
        # @see Spotted::Models::AlbumListResponse::Album#restrictions
        class Restrictions < Spotted::Internal::Type::BaseModel
          ...
          #   the future.
          #
          #   @return [Symbol, Spotted::Models::AlbumListResponse::Album::Restrictions::Reason, nil]
          optional :reason, enum: -> { Spotted::Models::AlbumListResponse::Album::Restrictions::Reason }

          # @!method initialize(reason: nil)
          #   Some parameter documentations has been truncated, see
          #   {Spotted::Models::AlbumListResponse::Album::Restrictions} for more details.
          #
          #   Included in the response when a content restriction is applied.
          #
          #   @param reason [Symbol, Spotted::Models::AlbumListResponse::Album::Restrictions::Reason] The reason for the restriction. Albums may be restricted if the content is not a
          ...
          # the future.
          #
          # @see Spotted::Models::AlbumListResponse::Album::Restrictions#reason
          module Reason
            extend Spotted::Internal::Type::Enum
        ...
        class Tracks < Spotted::Internal::Type::BaseModel
          ...
          # @!attribute items
          #
          #   @return [Array<Spotted::Models::AlbumListResponse::Album::Tracks::Item>]
          required :items,
                   -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::AlbumListResponse::Album::Tracks::Item] }
          ...
          #
          #   @param items [Array<Spotted::Models::AlbumListResponse::Album::Tracks::Item>]
          #
          ...
          class Item < Spotted::Internal::Type::BaseModel
            ...
            #
            #   @return [Array<Spotted::Models::AlbumListResponse::Album::Tracks::Item::Artist>, nil]
            optional :artists,
                     -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::AlbumListResponse::Album::Tracks::Item::Artist] }
            ...
            #
            #   @return [Spotted::Models::AlbumListResponse::Album::Tracks::Item::ExternalURLs, nil]
            optional :external_urls, -> { Spotted::Models::AlbumListResponse::Album::Tracks::Item::ExternalURLs }
            ...
            #
            #   @return [Spotted::Models::AlbumListResponse::Album::Tracks::Item::LinkedFrom, nil]
            optional :linked_from, -> { Spotted::Models::AlbumListResponse::Album::Tracks::Item::LinkedFrom }
            ...
            #   Included in the response when a content restriction is applied.
            #
            #   @return [Spotted::Models::AlbumListResponse::Album::Tracks::Item::Restrictions, nil]
            optional :restrictions, -> { Spotted::Models::AlbumListResponse::Album::Tracks::Item::Restrictions }
            ...
            #   Some parameter documentations has been truncated, see
            #   {Spotted::Models::AlbumListResponse::Album::Tracks::Item} for more details.
            #
            #   @param id [String] The [Spotify ID](/documentation/web-api/concepts/spotify-uris-ids) for the track
            #
            #   @param artists [Array<Spotted::Models::AlbumListResponse::Album::Tracks::Item::Artist>] The artists who performed the track. Each artist object includes a link in `href
            #
            ...
            #
            #   @param external_urls [Spotted::Models::AlbumListResponse::Album::Tracks::Item::ExternalURLs] External URLs for this track.
            #
            ...
            #
            #   @param linked_from [Spotted::Models::AlbumListResponse::Album::Tracks::Item::LinkedFrom] Part of the response when [Track Relinking](/documentation/web-api/concepts/trac
            #
            #   @param name [String] The name of the track.
            #
            #   @param preview_url [String, nil] A URL to a 30 second preview (MP3 format) of the track.
            #
            #   @param restrictions [Spotted::Models::AlbumListResponse::Album::Tracks::Item::Restrictions] Included in the response when a content restriction is applied.
            #
            ...
            class Artist < Spotted::Internal::Type::BaseModel
              ...
              #   Known external URLs for this artist.
              #
              #   @return [Spotted::Models::AlbumListResponse::Album::Tracks::Item::Artist::ExternalURLs, nil]
              ...
              #   The object type.
              #
              #   @return [Symbol, Spotted::Models::AlbumListResponse::Album::Tracks::Item::Artist::Type, nil]
              optional :type, enum: -> { Spotted::Models::AlbumListResponse::Album::Tracks::Item::Artist::Type }
              ...
              # @!method initialize(id: nil, external_urls: nil, href: nil, name: nil, type: nil, uri: nil)
              #   Some parameter documentations has been truncated, see
              #   {Spotted::Models::AlbumListResponse::Album::Tracks::Item::Artist} for more
              #   details.
              #
              #   @param id [String] The [Spotify ID](/documentation/web-api/concepts/spotify-uris-ids) for the artis
              #
              #   @param external_urls [Spotted::Models::AlbumListResponse::Album::Tracks::Item::Artist::ExternalURLs] Known external URLs for this artist.
              #
              #   @param href [String] A link to the Web API endpoint providing full details of the artist.
              #
              #   @param name [String] The name of the artist.
              #
              #   @param type [Symbol, Spotted::Models::AlbumListResponse::Album::Tracks::Item::Artist::Type] The object type.
              #
              #   @param uri [String] The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for the arti

              # @see Spotted::Models::AlbumListResponse::Album::Tracks::Item::Artist#external_urls
              class ExternalURLs < Spotted::Internal::Type::BaseModel
                # @!attribute spotify
                #   The [Spotify URL](/documentation/web-api/concepts/spotify-uris-ids) for the
                #   object.
              ...
              # The object type.
              #
              # @see Spotted::Models::AlbumListResponse::Album::Tracks::Item::Artist#type
              module Type
                extend Spotted::Internal::Type::Enum
            ...
            # @see Spotted::Models::AlbumListResponse::Album::Tracks::Item#external_urls
            class ExternalURLs < Spotted::Internal::Type::BaseModel
              # @!attribute spotify
              #   The [Spotify URL](/documentation/web-api/concepts/spotify-uris-ids) for the
              #   object.
              ...
              # @!method initialize(spotify: nil)
              #   Some parameter documentations has been truncated, see
              #   {Spotted::Models::AlbumListResponse::Album::Tracks::Item::ExternalURLs} for more
              #   details.
              #
              #   External URLs for this track.
              #
            ...
            # @see Spotted::Models::AlbumListResponse::Album::Tracks::Item#linked_from
            class LinkedFrom < Spotted::Internal::Type::BaseModel
              ...
              #
              #   @return [Spotted::Models::AlbumListResponse::Album::Tracks::Item::LinkedFrom::ExternalURLs, nil]
              optional :external_urls,
              ...
              #   Some parameter documentations has been truncated, see
              #   {Spotted::Models::AlbumListResponse::Album::Tracks::Item::LinkedFrom} for more
              #   details.
              #
              #   Part of the response when
              #   [Track Relinking](/documentation/web-api/concepts/track-relinking/) is applied
              ...
              #   @param id [String] The [Spotify ID](/documentation/web-api/concepts/spotify-uris-ids) for the track
              #
              #   @param external_urls [Spotted::Models::AlbumListResponse::Album::Tracks::Item::LinkedFrom::ExternalURLs] Known external URLs for this track.
              #
              #   @param href [String] A link to the Web API endpoint providing full details of the track.
              #
              #   @param type [String] The object type: "track".
              ...
              # @see Spotted::Models::AlbumListResponse::Album::Tracks::Item::LinkedFrom#external_urls
              class ExternalURLs < Spotted::Internal::Type::BaseModel
                # @!attribute spotify
                #   The [Spotify URL](/documentation/web-api/concepts/spotify-uris-ids) for the
                #   object.
            ...
            # @see Spotted::Models::AlbumListResponse::Album::Tracks::Item#restrictions
            class Restrictions < Spotted::Internal::Type::BaseModel
              # @!attribute reason
              ...
              # @!method initialize(reason: nil)
              #   Some parameter documentations has been truncated, see
              #   {Spotted::Models::AlbumListResponse::Album::Tracks::Item::Restrictions} for more
              #   details.
              #
              #   Included in the response when a content restriction is applied.
              #
