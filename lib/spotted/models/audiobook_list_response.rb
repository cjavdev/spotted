  ...
  module Models
    ...
    class AudiobookListResponse < Spotted::Internal::Type::BaseModel
      ...
      class Audiobook < Spotted::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<Spotted::Models::AudiobookListResponse::Audiobook::Author>]
        required :authors,
                 -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::AudiobookListResponse::Audiobook::Author] }
        ...
        #
        #   @return [Array<Spotted::Models::AudiobookListResponse::Audiobook::Copyright>]
        required :copyrights,
                 -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::AudiobookListResponse::Audiobook::Copyright] }
        ...
        #
        #   @return [Spotted::Models::AudiobookListResponse::Audiobook::ExternalURLs]
        required :external_urls, -> { Spotted::Models::AudiobookListResponse::Audiobook::ExternalURLs }
        ...
        #
        #   @return [Array<Spotted::Models::AudiobookListResponse::Audiobook::Image>]
        required :images,
                 -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::AudiobookListResponse::Audiobook::Image] }
        ...
        #
        #   @return [Array<Spotted::Models::AudiobookListResponse::Audiobook::Narrator>]
        required :narrators,
                 -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::AudiobookListResponse::Audiobook::Narrator] }
        ...
        #
        #   @param authors [Array<Spotted::Models::AudiobookListResponse::Audiobook::Author>] The author(s) for the audiobook.
        #
        ...
        #
        #   @param copyrights [Array<Spotted::Models::AudiobookListResponse::Audiobook::Copyright>] The copyright statements of the audiobook.
        #
        ...
        #
        #   @param external_urls [Spotted::Models::AudiobookListResponse::Audiobook::ExternalURLs] External URLs for this audiobook.
        #
        ...
        #
        #   @param images [Array<Spotted::Models::AudiobookListResponse::Audiobook::Image>] The cover art for the audiobook in various sizes, widest first.
        #
        ...
        #
        #   @param narrators [Array<Spotted::Models::AudiobookListResponse::Audiobook::Narrator>] The narrator(s) for the audiobook.
        #
        ...
        class Author < Spotted::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Spotted::Models::AudiobookListResponse::Audiobook::Author} for more details.
          #
        ...
        class Chapters < Spotted::Internal::Type::BaseModel
          ...
          # @!attribute items
          #
          #   @return [Array<Spotted::Models::AudiobookListResponse::Audiobook::Chapters::Item>]
          required :items,
                   -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::AudiobookListResponse::Audiobook::Chapters::Item] }
          ...
          #
          #   @param items [Array<Spotted::Models::AudiobookListResponse::Audiobook::Chapters::Item>]
          #
          ...
          class Item < Spotted::Internal::Type::BaseModel
            ...
            #
            #   @return [Spotted::Models::AudiobookListResponse::Audiobook::Chapters::Item::ExternalURLs]
            ...
            #
            #   @return [Array<Spotted::Models::AudiobookListResponse::Audiobook::Chapters::Item::Image>]
            required :images,
                     -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::AudiobookListResponse::Audiobook::Chapters::Item::Image] }
            ...
            #
            #   @return [Symbol, Spotted::Models::AudiobookListResponse::Audiobook::Chapters::Item::ReleaseDatePrecision]
            required :release_date_precision,
                     enum: -> { Spotted::Models::AudiobookListResponse::Audiobook::Chapters::Item::ReleaseDatePrecision }

            # @!attribute type
            #   The object type.
            #
            #   @return [Symbol, Spotted::Models::AudiobookListResponse::Audiobook::Chapters::Item::Type]
            required :type, enum: -> { Spotted::Models::AudiobookListResponse::Audiobook::Chapters::Item::Type }
            ...
            #
            #   @return [Spotted::Models::AudiobookListResponse::Audiobook::Chapters::Item::Restrictions, nil]
            ...
            #
            #   @return [Spotted::Models::AudiobookListResponse::Audiobook::Chapters::Item::ResumePoint, nil]
            ...
            #   Some parameter documentations has been truncated, see
            #   {Spotted::Models::AudiobookListResponse::Audiobook::Chapters::Item} for more
            #   details.
            #
            ...
            #
            #   @param external_urls [Spotted::Models::AudiobookListResponse::Audiobook::Chapters::Item::ExternalURLs] External URLs for this chapter.
            #
            ...
            #
            #   @param images [Array<Spotted::Models::AudiobookListResponse::Audiobook::Chapters::Item::Image>] The cover art for the chapter in various sizes, widest first.
            #
            ...
            #
            #   @param release_date_precision [Symbol, Spotted::Models::AudiobookListResponse::Audiobook::Chapters::Item::ReleaseDatePrecision] The precision with which `release_date` value is known.
            #
            #   @param type [Symbol, Spotted::Models::AudiobookListResponse::Audiobook::Chapters::Item::Type] The object type.
            #
            ...
            #
            #   @param restrictions [Spotted::Models::AudiobookListResponse::Audiobook::Chapters::Item::Restrictions] Included in the response when a content restriction is applied.
            #
            #   @param resume_point [Spotted::Models::AudiobookListResponse::Audiobook::Chapters::Item::ResumePoint] The user's most recent position in the chapter. Set if the supplied access token

            # @see Spotted::Models::AudiobookListResponse::Audiobook::Chapters::Item#external_urls
            ...
            class Image < Spotted::Internal::Type::BaseModel
              ...
              #   Some parameter documentations has been truncated, see
              #   {Spotted::Models::AudiobookListResponse::Audiobook::Chapters::Item::Image} for
              #   more details.
              #
            ...
            # The precision with which `release_date` value is known.
            #
            # @see Spotted::Models::AudiobookListResponse::Audiobook::Chapters::Item#release_date_precision
            ...
            # The object type.
            #
            # @see Spotted::Models::AudiobookListResponse::Audiobook::Chapters::Item#type
            module Type
              extend Spotted::Internal::Type::Enum
            ...
            # @see Spotted::Models::AudiobookListResponse::Audiobook::Chapters::Item#restrictions
            ...
            # @see Spotted::Models::AudiobookListResponse::Audiobook::Chapters::Item#resume_point
        ...
        class Copyright < Spotted::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Spotted::Models::AudiobookListResponse::Audiobook::Copyright} for more details.
          #
        ...
        # @see Spotted::Models::AudiobookListResponse::Audiobook#external_urls
        class ExternalURLs < Spotted::Internal::Type::BaseModel
          # @!attribute spotify
          #   The [Spotify URL](/documentation/web-api/concepts/spotify-uris-ids) for the
          #   object.
          ...
          # @!method initialize(spotify: nil)
          #   Some parameter documentations has been truncated, see
          #   {Spotted::Models::AudiobookListResponse::Audiobook::ExternalURLs} for more
          #   details.
          #
          #   External URLs for this audiobook.
          #
        ...
        class Image < Spotted::Internal::Type::BaseModel
          ...
          # @!method initialize(height:, url:, width:)
          #   Some parameter documentations has been truncated, see
          #   {Spotted::Models::AudiobookListResponse::Audiobook::Image} for more details.
          #
          #   @param height [Integer, nil] The image height in pixels.
          #
          #   @param url [String] The source URL of the image.
        ...
        class Narrator < Spotted::Internal::Type::BaseModel
          ...
          # @!method initialize(name: nil)
          #   Some parameter documentations has been truncated, see
          #   {Spotted::Models::AudiobookListResponse::Audiobook::Narrator} for more details.
          #
