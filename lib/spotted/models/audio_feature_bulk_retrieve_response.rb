...
module Spotted
  module Models
    # @see Spotted::Resources::AudioFeatures#bulk_retrieve
    class AudioFeatureBulkRetrieveResponse < Spotted::Internal::Type::BaseModel
      # @!attribute audio_features
      #
      #   @return [Array<Spotted::Models::AudioFeatureBulkRetrieveResponse::AudioFeature>]
      required :audio_features,
               -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::AudioFeatureBulkRetrieveResponse::AudioFeature] }

      # @!method initialize(audio_features:)
      #   @param audio_features [Array<Spotted::Models::AudioFeatureBulkRetrieveResponse::AudioFeature>]
      ...
      class AudioFeature < Spotted::Internal::Type::BaseModel
        ...
        #   The object type.
        #
        #   @return [Symbol, Spotted::Models::AudioFeatureBulkRetrieveResponse::AudioFeature::Type, nil]
        optional :type, enum: -> { Spotted::Models::AudioFeatureBulkRetrieveResponse::AudioFeature::Type }
        ...
        #
        #   @param type [Symbol, Spotted::Models::AudioFeatureBulkRetrieveResponse::AudioFeature::Type] The object type.
        #
        ...
        # The object type.
        #
        # @see Spotted::Models::AudioFeatureBulkRetrieveResponse::AudioFeature#type
        module Type
