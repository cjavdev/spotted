...
module Spotted
  module Models
    ...
    class AudioFeatureRetrieveResponse < Spotted::Internal::Type::BaseModel
      ...
      #   The object type.
      #
      #   @return [Symbol, Spotted::Models::AudioFeatureRetrieveResponse::Type, nil]
      ...
      #
      #   @param type [Symbol, Spotted::Models::AudioFeatureRetrieveResponse::Type] The object type.
      #
      ...
      # The object type.
      #
      # @see Spotted::Models::AudioFeatureRetrieveResponse#type
      module Type
