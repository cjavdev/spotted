...
module Spotted
  module Models
    ...
    class ShowRetrieveResponse < Spotted::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Spotted::Models::ShowRetrieveResponse::Copyright>]
      required :copyrights,
               -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::ShowRetrieveResponse::Copyright] }
      ...
      #
      #   @return [Spotted::Models::ShowRetrieveResponse::ExternalURLs]
      required :external_urls, -> { Spotted::Models::ShowRetrieveResponse::ExternalURLs }
      ...
      #
      #   @return [Array<Spotted::Models::ShowRetrieveResponse::Image>]
      required :images, -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::ShowRetrieveResponse::Image] }
      ...
      #
      #   @param copyrights [Array<Spotted::Models::ShowRetrieveResponse::Copyright>] The copyright statements of the show.
      #
      ...
      #
      #   @param external_urls [Spotted::Models::ShowRetrieveResponse::ExternalURLs] External URLs for this show.
      #
      ...
      #
      #   @param images [Array<Spotted::Models::ShowRetrieveResponse::Image>] The cover art for the show in various sizes, widest first.
      #
      ...
      class Copyright < Spotted::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {Spotted::Models::ShowRetrieveResponse::Copyright} for more details.
        #
      ...
      class Episodes < Spotted::Internal::Type::BaseModel
        ...
        # @!attribute items
        #
        #   @return [Array<Spotted::Models::ShowRetrieveResponse::Episodes::Item>]
        required :items,
                 -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::ShowRetrieveResponse::Episodes::Item] }
        ...
        #
        #   @param items [Array<Spotted::Models::ShowRetrieveResponse::Episodes::Item>]
        #
        ...
        class Item < Spotted::Internal::Type::BaseModel
          ...
          #
          #   @return [Spotted::Models::ShowRetrieveResponse::Episodes::Item::ExternalURLs]
          required :external_urls, -> { Spotted::Models::ShowRetrieveResponse::Episodes::Item::ExternalURLs }
          ...
          #
          #   @return [Array<Spotted::Models::ShowRetrieveResponse::Episodes::Item::Image>]
          required :images,
                   -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::ShowRetrieveResponse::Episodes::Item::Image] }
          ...
          #
          #   @return [Symbol, Spotted::Models::ShowRetrieveResponse::Episodes::Item::ReleaseDatePrecision]
          required :release_date_precision,
                   enum: -> { Spotted::Models::ShowRetrieveResponse::Episodes::Item::ReleaseDatePrecision }

          # @!attribute type
          #   The object type.
          #
          #   @return [Symbol, Spotted::Models::ShowRetrieveResponse::Episodes::Item::Type]
          required :type, enum: -> { Spotted::Models::ShowRetrieveResponse::Episodes::Item::Type }
          ...
          #
          #   @return [Spotted::Models::ShowRetrieveResponse::Episodes::Item::Restrictions, nil]
          optional :restrictions, -> { Spotted::Models::ShowRetrieveResponse::Episodes::Item::Restrictions }

          # @!attribute resume_point
          #   The user's most recent position in the episode. Set if the supplied access token
          #   is a user token and has the scope 'user-read-playback-position'.
          #
          #   @return [Spotted::Models::ShowRetrieveResponse::Episodes::Item::ResumePoint, nil]
          optional :resume_point, -> { Spotted::Models::ShowRetrieveResponse::Episodes::Item::ResumePoint }
          ...
          #   Some parameter documentations has been truncated, see
          #   {Spotted::Models::ShowRetrieveResponse::Episodes::Item} for more details.
          #
          ...
          #
          #   @param external_urls [Spotted::Models::ShowRetrieveResponse::Episodes::Item::ExternalURLs] External URLs for this episode.
          #
          ...
          #
          #   @param images [Array<Spotted::Models::ShowRetrieveResponse::Episodes::Item::Image>] The cover art for the episode in various sizes, widest first.
          #
          ...
          #
          #   @param release_date_precision [Symbol, Spotted::Models::ShowRetrieveResponse::Episodes::Item::ReleaseDatePrecision] The precision with which `release_date` value is known.
          #
          #   @param type [Symbol, Spotted::Models::ShowRetrieveResponse::Episodes::Item::Type] The object type.
          #
          ...
          #
          #   @param restrictions [Spotted::Models::ShowRetrieveResponse::Episodes::Item::Restrictions] Included in the response when a content restriction is applied.
          #
          #   @param resume_point [Spotted::Models::ShowRetrieveResponse::Episodes::Item::ResumePoint] The user's most recent position in the episode. Set if the supplied access token

          # @see Spotted::Models::ShowRetrieveResponse::Episodes::Item#external_urls
          class ExternalURLs < Spotted::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {Spotted::Models::ShowRetrieveResponse::Episodes::Item::ExternalURLs} for more
            #   details.
            #
            #   External URLs for this episode.
            #
          ...
          class Image < Spotted::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {Spotted::Models::ShowRetrieveResponse::Episodes::Item::Image} for more details.
            #
          ...
          # The precision with which `release_date` value is known.
          #
          # @see Spotted::Models::ShowRetrieveResponse::Episodes::Item#release_date_precision
          ...
          # The object type.
          #
          # @see Spotted::Models::ShowRetrieveResponse::Episodes::Item#type
          module Type
            extend Spotted::Internal::Type::Enum
          ...
          # @see Spotted::Models::ShowRetrieveResponse::Episodes::Item#restrictions
          class Restrictions < Spotted::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {Spotted::Models::ShowRetrieveResponse::Episodes::Item::Restrictions} for more
            #   details.
            #
            #   Included in the response when a content restriction is applied.
            #
          ...
          # @see Spotted::Models::ShowRetrieveResponse::Episodes::Item#resume_point
          class ResumePoint < Spotted::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {Spotted::Models::ShowRetrieveResponse::Episodes::Item::ResumePoint} for more
            #   details.
            #
            #   The user's most recent position in the episode. Set if the supplied access token
            #   is a user token and has the scope 'user-read-playback-position'.
      ...
      # @see Spotted::Models::ShowRetrieveResponse#external_urls
      class ExternalURLs < Spotted::Internal::Type::BaseModel
        # @!attribute spotify
        #   The [Spotify URL](/documentation/web-api/concepts/spotify-uris-ids) for the
        #   object.
        ...
        # @!method initialize(spotify: nil)
        #   Some parameter documentations has been truncated, see
        #   {Spotted::Models::ShowRetrieveResponse::ExternalURLs} for more details.
        #
        #   External URLs for this show.
        #
        #   @param spotify [String] The [Spotify URL](/documentation/web-api/concepts/spotify-uris-ids) for the obje
      ...
      class Image < Spotted::Internal::Type::BaseModel
        ...
        # @!method initialize(height:, url:, width:)
        #   Some parameter documentations has been truncated, see
        #   {Spotted::Models::ShowRetrieveResponse::Image} for more details.
        #
        #   @param height [Integer, nil] The image height in pixels.
        #
        #   @param url [String] The source URL of the image.
