...
module Spotted
  module Models
    class SimplifiedEpisodeObject < Spotted::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Spotted::Models::SimplifiedEpisodeObject::ReleaseDatePrecision]
      required :release_date_precision, enum: -> { Spotted::SimplifiedEpisodeObject::ReleaseDatePrecision }

      # @!attribute type
      #   The object type.
      #
      #   @return [Symbol, Spotted::Models::SimplifiedEpisodeObject::Type]
      required :type, enum: -> { Spotted::SimplifiedEpisodeObject::Type }
      ...
      # The precision with which `release_date` value is known.
      #
      # @see Spotted::Models::SimplifiedEpisodeObject#release_date_precision
