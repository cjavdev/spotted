  ...
  module Models
    module Users
      ...
      class PlaylistListResponse < Spotted::Internal::Type::BaseModel
        ...
        # @!attribute items
        #
        #   @return [Array<Spotted::Models::Users::PlaylistListResponse::Item>]
        required :items,
                 -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::Users::PlaylistListResponse::Item] }
        ...
        #   {Spotted::Models::Users::PlaylistListResponse} for more details.
        #
        #   @param href [String] A link to the Web API endpoint returning the full result of the request
        #
        #   @param items [Array<Spotted::Models::Users::PlaylistListResponse::Item>]
        #
        ...
        class Item < Spotted::Internal::Type::BaseModel
          ...
          #
          #   @return [Spotted::Models::Users::PlaylistListResponse::Item::ExternalURLs, nil]
          optional :external_urls, -> { Spotted::Models::Users::PlaylistListResponse::Item::ExternalURLs }
          ...
          #
          #   @return [Array<Spotted::Models::Users::PlaylistListResponse::Item::Image>, nil]
          optional :images,
                   -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::Users::PlaylistListResponse::Item::Image] }
          ...
          #
          #   @return [Spotted::Models::Users::PlaylistListResponse::Item::Owner, nil]
          optional :owner, -> { Spotted::Models::Users::PlaylistListResponse::Item::Owner }
          ...
          #
          #   @return [Spotted::Models::Users::PlaylistListResponse::Item::Tracks, nil]
          optional :tracks, -> { Spotted::Models::Users::PlaylistListResponse::Item::Tracks }
          ...
          #   Some parameter documentations has been truncated, see
          #   {Spotted::Models::Users::PlaylistListResponse::Item} for more details.
          #
          ...
          #   other
          #
          #   @param external_urls [Spotted::Models::Users::PlaylistListResponse::Item::ExternalURLs] Known external URLs for this playlist.
          #
          #   @param href [String] A link to the Web API endpoint providing full details of the playlist.
          #
          #   @param images [Array<Spotted::Models::Users::PlaylistListResponse::Item::Image>] Images for the playlist. The array may be empty or contain up to three images. T
          #
          #   @param name [String] The name of the playlist.
          #
          #   @param owner [Spotted::Models::Users::PlaylistListResponse::Item::Owner] The user who owns the playlist
          #
          ...
          #
          #   @param tracks [Spotted::Models::Users::PlaylistListResponse::Item::Tracks] A collection containing a link ( `href` ) to the Web API endpoint where full det
          #
          ...
          # @see Spotted::Models::Users::PlaylistListResponse::Item#external_urls
          class ExternalURLs < Spotted::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {Spotted::Models::Users::PlaylistListResponse::Item::ExternalURLs} for more
            #   details.
            #
            #   Known external URLs for this playlist.
            #
          ...
          class Image < Spotted::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {Spotted::Models::Users::PlaylistListResponse::Item::Image} for more details.
            #
          ...
          # @see Spotted::Models::Users::PlaylistListResponse::Item#owner
          class Owner < Spotted::Internal::Type::BaseModel
            ...
            #
            #   @return [Spotted::Models::Users::PlaylistListResponse::Item::Owner::ExternalURLs, nil]
            optional :external_urls, -> { Spotted::Models::Users::PlaylistListResponse::Item::Owner::ExternalURLs }
            ...
            #   The object type.
            #
            #   @return [Symbol, Spotted::Models::Users::PlaylistListResponse::Item::Owner::Type, nil]
            optional :type, enum: -> { Spotted::Models::Users::PlaylistListResponse::Item::Owner::Type }
            ...
            #   Some parameter documentations has been truncated, see
            #   {Spotted::Models::Users::PlaylistListResponse::Item::Owner} for more details.
            #
            #   The user who owns the playlist
            #
            ...
            #
            #   @param external_urls [Spotted::Models::Users::PlaylistListResponse::Item::Owner::ExternalURLs] Known public external URLs for this user.
            #
            #   @param href [String] A link to the Web API endpoint for this user.
            #
            #   @param type [Symbol, Spotted::Models::Users::PlaylistListResponse::Item::Owner::Type] The object type.
            #
            #   @param uri [String] The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for this use

            # @see Spotted::Models::Users::PlaylistListResponse::Item::Owner#external_urls
            class ExternalURLs < Spotted::Internal::Type::BaseModel
              # @!attribute spotify
              #   The [Spotify URL](/documentation/web-api/concepts/spotify-uris-ids) for the
              #   object.
              ...
              # @!method initialize(spotify: nil)
              #   Some parameter documentations has been truncated, see
              #   {Spotted::Models::Users::PlaylistListResponse::Item::Owner::ExternalURLs} for
              #   more details.
              #
              #   Known public external URLs for this user.
              #
            ...
            # The object type.
            #
            # @see Spotted::Models::Users::PlaylistListResponse::Item::Owner#type
            module Type
          ...
          # @see Spotted::Models::Users::PlaylistListResponse::Item#tracks
          class Tracks < Spotted::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {Spotted::Models::Users::PlaylistListResponse::Item::Tracks} for more details.
            #
            #   A collection containing a link ( `href` ) to the Web API endpoint where full
            #   details of the playlist's tracks can be retrieved, along with the `total` number
            #   of tracks in the playlist. Note, a track object may be `null`. This can happen
