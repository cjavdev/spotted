...
module Spotted
  module Models
    # @see Spotted::Resources::Chapters#bulk_retrieve
    class ChapterBulkRetrieveResponse < Spotted::Internal::Type::BaseModel
      # @!attribute chapters
      #
      #   @return [Array<Spotted::Models::ChapterBulkRetrieveResponse::Chapter>]
      required :chapters,
               -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::ChapterBulkRetrieveResponse::Chapter] }

      # @!method initialize(chapters:)
      #   @param chapters [Array<Spotted::Models::ChapterBulkRetrieveResponse::Chapter>]
      ...
      class Chapter < Spotted::Internal::Type::BaseModel
        ...
        #   The object type.
        #
        #   @return [Symbol, Spotted::Models::ChapterBulkRetrieveResponse::Chapter::Type]
        required :type, enum: -> { Spotted::Models::ChapterBulkRetrieveResponse::Chapter::Type }
