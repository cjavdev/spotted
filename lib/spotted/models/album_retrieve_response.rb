...
module Spotted
  module Models
    # @see Spotted::Resources::Albums#retrieve
    class AlbumRetrieveResponse < Spotted::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Spotted::Models::AlbumRetrieveResponse::AlbumType]
      ...
      #
      #   @return [Spotted::Models::AlbumRetrieveResponse::ExternalURLs]
      required :external_urls, -> { Spotted::Models::AlbumRetrieveResponse::ExternalURLs }
      ...
      #
      #   @return [Array<Spotted::Models::AlbumRetrieveResponse::Image>]
      required :images, -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::AlbumRetrieveResponse::Image] }
      ...
      #
      #   @return [Symbol, Spotted::Models::AlbumRetrieveResponse::ReleaseDatePrecision]
      ...
      #
      #   @return [Array<Spotted::Models::AlbumRetrieveResponse::Artist>, nil]
      optional :artists, -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::AlbumRetrieveResponse::Artist] }

      # @!attribute copyrights
      #   The copyright statements of the album.
      #
      #   @return [Array<Spotted::Models::AlbumRetrieveResponse::Copyright>, nil]
      optional :copyrights,
               -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::AlbumRetrieveResponse::Copyright] }

      # @!attribute external_ids
      #   Known external IDs for the album.
      #
      #   @return [Spotted::Models::AlbumRetrieveResponse::ExternalIDs, nil]
      optional :external_ids, -> { Spotted::Models::AlbumRetrieveResponse::ExternalIDs }
      ...
      #
      #   @return [Spotted::Models::AlbumRetrieveResponse::Restrictions, nil]
      optional :restrictions, -> { Spotted::Models::AlbumRetrieveResponse::Restrictions }
      ...
      #
      #   @param album_type [Symbol, Spotted::Models::AlbumRetrieveResponse::AlbumType] The type of the album.
      #
      #   @param available_markets [Array<String>] The markets in which the album is available: [ISO 3166-1 alpha-2 country codes](
      #
      #   @param external_urls [Spotted::Models::AlbumRetrieveResponse::ExternalURLs] Known external URLs for this album.
      #
      #   @param href [String] A link to the Web API endpoint providing full details of the album.
      #
      #   @param images [Array<Spotted::Models::AlbumRetrieveResponse::Image>] The cover art for the album in various sizes, widest first.
      #
      ...
      #
      #   @param release_date_precision [Symbol, Spotted::Models::AlbumRetrieveResponse::ReleaseDatePrecision] The precision with which `release_date` value is known.
      #
      ...
      #
      #   @param artists [Array<Spotted::Models::AlbumRetrieveResponse::Artist>] The artists of the album. Each artist object includes a link in `href` to more d
      #
      #   @param copyrights [Array<Spotted::Models::AlbumRetrieveResponse::Copyright>] The copyright statements of the album.
      #
      #   @param external_ids [Spotted::Models::AlbumRetrieveResponse::ExternalIDs] Known external IDs for the album.
      #
      ...
      #
      #   @param restrictions [Spotted::Models::AlbumRetrieveResponse::Restrictions] Included in the response when a content restriction is applied.
      #
      #   @param tracks [Spotted::Models::AlbumRetrieveResponse::Tracks] The tracks of the album.

      # The type of the album.
      #
      # @see Spotted::Models::AlbumRetrieveResponse#album_type
      module AlbumType
      ...
      # @see Spotted::Models::AlbumRetrieveResponse#external_urls
      class ExternalURLs < Spotted::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {Spotted::Models::AlbumRetrieveResponse::ExternalURLs} for more details.
        #
        #   Known external URLs for this album.
        #
      ...
      class Image < Spotted::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {Spotted::Models::AlbumRetrieveResponse::Image} for more details.
        #
      ...
      # The precision with which `release_date` value is known.
      #
      # @see Spotted::Models::AlbumRetrieveResponse#release_date_precision
      ...
      class Artist < Spotted::Internal::Type::BaseModel
        ...
        #
        #   @return [Spotted::Models::AlbumRetrieveResponse::Artist::ExternalURLs, nil]
        optional :external_urls, -> { Spotted::Models::AlbumRetrieveResponse::Artist::ExternalURLs }
        ...
        #   The object type.
        #
        #   @return [Symbol, Spotted::Models::AlbumRetrieveResponse::Artist::Type, nil]
        optional :type, enum: -> { Spotted::Models::AlbumRetrieveResponse::Artist::Type }
        ...
        #   Some parameter documentations has been truncated, see
        #   {Spotted::Models::AlbumRetrieveResponse::Artist} for more details.
        #
        #   @param id [String] The [Spotify ID](/documentation/web-api/concepts/spotify-uris-ids) for the artis
        #
        #   @param external_urls [Spotted::Models::AlbumRetrieveResponse::Artist::ExternalURLs] Known external URLs for this artist.
        #
        ...
        #
        #   @param type [Symbol, Spotted::Models::AlbumRetrieveResponse::Artist::Type] The object type.
        #
        #   @param uri [String] The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for the arti

        # @see Spotted::Models::AlbumRetrieveResponse::Artist#external_urls
        class ExternalURLs < Spotted::Internal::Type::BaseModel
          # @!attribute spotify
          #   The [Spotify URL](/documentation/web-api/concepts/spotify-uris-ids) for the
          #   object.
          ...
          # @!method initialize(spotify: nil)
          #   Some parameter documentations has been truncated, see
          #   {Spotted::Models::AlbumRetrieveResponse::Artist::ExternalURLs} for more details.
          #
          #   Known external URLs for this artist.
          #
          #   @param spotify [String] The [Spotify URL](/documentation/web-api/concepts/spotify-uris-ids) for the obje
        ...
        # The object type.
        #
        # @see Spotted::Models::AlbumRetrieveResponse::Artist#type
        module Type
          extend Spotted::Internal::Type::Enum
      ...
      class Copyright < Spotted::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {Spotted::Models::AlbumRetrieveResponse::Copyright} for more details.
        #
      ...
      # @see Spotted::Models::AlbumRetrieveResponse#external_ids
      class ExternalIDs < Spotted::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {Spotted::Models::AlbumRetrieveResponse::ExternalIDs} for more details.
        #
        #   Known external IDs for the album.
        #
      ...
      # @see Spotted::Models::AlbumRetrieveResponse#restrictions
      class Restrictions < Spotted::Internal::Type::BaseModel
        ...
        #   the future.
        #
        #   @return [Symbol, Spotted::Models::AlbumRetrieveResponse::Restrictions::Reason, nil]
        optional :reason, enum: -> { Spotted::Models::AlbumRetrieveResponse::Restrictions::Reason }

        # @!method initialize(reason: nil)
        #   Some parameter documentations has been truncated, see
        #   {Spotted::Models::AlbumRetrieveResponse::Restrictions} for more details.
        #
        #   Included in the response when a content restriction is applied.
        #
        #   @param reason [Symbol, Spotted::Models::AlbumRetrieveResponse::Restrictions::Reason] The reason for the restriction. Albums may be restricted if the content is not a
        ...
        # the future.
        #
        # @see Spotted::Models::AlbumRetrieveResponse::Restrictions#reason
        module Reason
          extend Spotted::Internal::Type::Enum
      ...
      class Tracks < Spotted::Internal::Type::BaseModel
        ...
        # @!attribute items
        #
        #   @return [Array<Spotted::Models::AlbumRetrieveResponse::Tracks::Item>]
        required :items,
                 -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::AlbumRetrieveResponse::Tracks::Item] }
        ...
        #
        #   @param items [Array<Spotted::Models::AlbumRetrieveResponse::Tracks::Item>]
        #
        ...
        class Item < Spotted::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Spotted::Models::AlbumRetrieveResponse::Tracks::Item::Artist>, nil]
          optional :artists,
                   -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::AlbumRetrieveResponse::Tracks::Item::Artist] }
          ...
          #
          #   @return [Spotted::Models::AlbumRetrieveResponse::Tracks::Item::ExternalURLs, nil]
          optional :external_urls, -> { Spotted::Models::AlbumRetrieveResponse::Tracks::Item::ExternalURLs }
          ...
          #
          #   @return [Spotted::Models::AlbumRetrieveResponse::Tracks::Item::LinkedFrom, nil]
          optional :linked_from, -> { Spotted::Models::AlbumRetrieveResponse::Tracks::Item::LinkedFrom }
          ...
          #   Included in the response when a content restriction is applied.
          #
          #   @return [Spotted::Models::AlbumRetrieveResponse::Tracks::Item::Restrictions, nil]
          optional :restrictions, -> { Spotted::Models::AlbumRetrieveResponse::Tracks::Item::Restrictions }
          ...
          #   Some parameter documentations has been truncated, see
          #   {Spotted::Models::AlbumRetrieveResponse::Tracks::Item} for more details.
          #
          #   @param id [String] The [Spotify ID](/documentation/web-api/concepts/spotify-uris-ids) for the track
          #
          #   @param artists [Array<Spotted::Models::AlbumRetrieveResponse::Tracks::Item::Artist>] The artists who performed the track. Each artist object includes a link in `href
          #
          ...
          #
          #   @param external_urls [Spotted::Models::AlbumRetrieveResponse::Tracks::Item::ExternalURLs] External URLs for this track.
          #
          ...
          #
          #   @param linked_from [Spotted::Models::AlbumRetrieveResponse::Tracks::Item::LinkedFrom] Part of the response when [Track Relinking](/documentation/web-api/concepts/trac
          #
          #   @param name [String] The name of the track.
          #
          #   @param preview_url [String, nil] A URL to a 30 second preview (MP3 format) of the track.
          #
          #   @param restrictions [Spotted::Models::AlbumRetrieveResponse::Tracks::Item::Restrictions] Included in the response when a content restriction is applied.
          #
          ...
          class Artist < Spotted::Internal::Type::BaseModel
            ...
            #   Known external URLs for this artist.
            #
            #   @return [Spotted::Models::AlbumRetrieveResponse::Tracks::Item::Artist::ExternalURLs, nil]
            optional :external_urls, -> { Spotted::Models::AlbumRetrieveResponse::Tracks::Item::Artist::ExternalURLs }
            ...
            #   The object type.
            #
            #   @return [Symbol, Spotted::Models::AlbumRetrieveResponse::Tracks::Item::Artist::Type, nil]
            optional :type, enum: -> { Spotted::Models::AlbumRetrieveResponse::Tracks::Item::Artist::Type }
            ...
            # @!method initialize(id: nil, external_urls: nil, href: nil, name: nil, type: nil, uri: nil)
            #   Some parameter documentations has been truncated, see
            #   {Spotted::Models::AlbumRetrieveResponse::Tracks::Item::Artist} for more details.
            #
            #   @param id [String] The [Spotify ID](/documentation/web-api/concepts/spotify-uris-ids) for the artis
            #
            #   @param external_urls [Spotted::Models::AlbumRetrieveResponse::Tracks::Item::Artist::ExternalURLs] Known external URLs for this artist.
            #
            #   @param href [String] A link to the Web API endpoint providing full details of the artist.
            #
            #   @param name [String] The name of the artist.
            #
            #   @param type [Symbol, Spotted::Models::AlbumRetrieveResponse::Tracks::Item::Artist::Type] The object type.
            #
            #   @param uri [String] The [Spotify URI](/documentation/web-api/concepts/spotify-uris-ids) for the arti

            # @see Spotted::Models::AlbumRetrieveResponse::Tracks::Item::Artist#external_urls
            class ExternalURLs < Spotted::Internal::Type::BaseModel
              # @!attribute spotify
              #   The [Spotify URL](/documentation/web-api/concepts/spotify-uris-ids) for the
              #   object.
              ...
              # @!method initialize(spotify: nil)
              #   Some parameter documentations has been truncated, see
              #   {Spotted::Models::AlbumRetrieveResponse::Tracks::Item::Artist::ExternalURLs} for
              #   more details.
              #
              #   Known external URLs for this artist.
              #
            ...
            # The object type.
            #
            # @see Spotted::Models::AlbumRetrieveResponse::Tracks::Item::Artist#type
            module Type
              extend Spotted::Internal::Type::Enum
          ...
          # @see Spotted::Models::AlbumRetrieveResponse::Tracks::Item#external_urls
          class ExternalURLs < Spotted::Internal::Type::BaseModel
            # @!attribute spotify
            #   The [Spotify URL](/documentation/web-api/concepts/spotify-uris-ids) for the
            #   object.
            ...
            # @!method initialize(spotify: nil)
            #   Some parameter documentations has been truncated, see
            #   {Spotted::Models::AlbumRetrieveResponse::Tracks::Item::ExternalURLs} for more
            #   details.
            #
            #   External URLs for this track.
            #
          ...
          # @see Spotted::Models::AlbumRetrieveResponse::Tracks::Item#linked_from
          class LinkedFrom < Spotted::Internal::Type::BaseModel
            ...
            #
            #   @return [Spotted::Models::AlbumRetrieveResponse::Tracks::Item::LinkedFrom::ExternalURLs, nil]
            ...
            #   Some parameter documentations has been truncated, see
            #   {Spotted::Models::AlbumRetrieveResponse::Tracks::Item::LinkedFrom} for more
            #   details.
            #
            #   Part of the response when
            #   [Track Relinking](/documentation/web-api/concepts/track-relinking/) is applied
            ...
            #   @param id [String] The [Spotify ID](/documentation/web-api/concepts/spotify-uris-ids) for the track
            #
            #   @param external_urls [Spotted::Models::AlbumRetrieveResponse::Tracks::Item::LinkedFrom::ExternalURLs] Known external URLs for this track.
            #
            #   @param href [String] A link to the Web API endpoint providing full details of the track.
            #
            #   @param type [String] The object type: "track".
            ...
            # @see Spotted::Models::AlbumRetrieveResponse::Tracks::Item::LinkedFrom#external_urls
            class ExternalURLs < Spotted::Internal::Type::BaseModel
              # @!attribute spotify
              #   The [Spotify URL](/documentation/web-api/concepts/spotify-uris-ids) for the
              #   object.
          ...
          # @see Spotted::Models::AlbumRetrieveResponse::Tracks::Item#restrictions
          class Restrictions < Spotted::Internal::Type::BaseModel
            # @!attribute reason
            ...
            # @!method initialize(reason: nil)
            #   Some parameter documentations has been truncated, see
            #   {Spotted::Models::AlbumRetrieveResponse::Tracks::Item::Restrictions} for more
            #   details.
            #
            #   Included in the response when a content restriction is applied.
            #
