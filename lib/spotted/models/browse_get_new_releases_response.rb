...
module Spotted
  module Models
    ...
    class BrowseGetNewReleasesResponse < Spotted::Internal::Type::BaseModel
      # @!attribute albums
      #
      #   @return [Spotted::Models::BrowseGetNewReleasesResponse::Albums]
      required :albums, -> { Spotted::Models::BrowseGetNewReleasesResponse::Albums }

      # @!method initialize(albums:)
      #   @param albums [Spotted::Models::BrowseGetNewReleasesResponse::Albums]

      # @see Spotted::Models::BrowseGetNewReleasesResponse#albums
