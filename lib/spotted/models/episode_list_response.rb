...
module Spotted
  module Models
    ...
    class EpisodeListResponse < Spotted::Internal::Type::BaseModel
      # @!attribute episodes
      #
      #   @return [Array<Spotted::Models::EpisodeListResponse::Episode>]
      required :episodes, -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::EpisodeListResponse::Episode] }

      # @!method initialize(episodes:)
      #   @param episodes [Array<Spotted::Models::EpisodeListResponse::Episode>]
      ...
      class Episode < Spotted::Internal::Type::BaseModel
        ...
        #
        #   @return [Spotted::Models::EpisodeListResponse::Episode::ExternalURLs]
        required :external_urls, -> { Spotted::Models::EpisodeListResponse::Episode::ExternalURLs }
        ...
        #
        #   @return [Array<Spotted::Models::EpisodeListResponse::Episode::Image>]
        required :images,
                 -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::EpisodeListResponse::Episode::Image] }
        ...
        #
        #   @return [Symbol, Spotted::Models::EpisodeListResponse::Episode::ReleaseDatePrecision]
        required :release_date_precision,
                 enum: -> { Spotted::Models::EpisodeListResponse::Episode::ReleaseDatePrecision }

        # @!attribute show
        #   The show on which the episode belongs.
        #
        #   @return [Spotted::Models::EpisodeListResponse::Episode::Show]
        required :show, -> { Spotted::Models::EpisodeListResponse::Episode::Show }

        # @!attribute type
        #   The object type.
        #
        #   @return [Symbol, Spotted::Models::EpisodeListResponse::Episode::Type]
        required :type, enum: -> { Spotted::Models::EpisodeListResponse::Episode::Type }
        ...
        #
        #   @return [Spotted::Models::EpisodeListResponse::Episode::Restrictions, nil]
        optional :restrictions, -> { Spotted::Models::EpisodeListResponse::Episode::Restrictions }

        # @!attribute resume_point
        #   The user's most recent position in the episode. Set if the supplied access token
        #   is a user token and has the scope 'user-read-playback-position'.
        #
        #   @return [Spotted::Models::EpisodeListResponse::Episode::ResumePoint, nil]
        optional :resume_point, -> { Spotted::Models::EpisodeListResponse::Episode::ResumePoint }
        ...
        #   {Spotted::Models::EpisodeListResponse::Episode} for more details.
        #
        ...
        #
        #   @param external_urls [Spotted::Models::EpisodeListResponse::Episode::ExternalURLs] External URLs for this episode.
        #
        ...
        #
        #   @param images [Array<Spotted::Models::EpisodeListResponse::Episode::Image>] The cover art for the episode in various sizes, widest first.
        #
        ...
        #
        #   @param release_date_precision [Symbol, Spotted::Models::EpisodeListResponse::Episode::ReleaseDatePrecision] The precision with which `release_date` value is known.
        #
        #   @param show [Spotted::Models::EpisodeListResponse::Episode::Show] The show on which the episode belongs.
        #
        #   @param type [Symbol, Spotted::Models::EpisodeListResponse::Episode::Type] The object type.
        #
        ...
        #
        #   @param restrictions [Spotted::Models::EpisodeListResponse::Episode::Restrictions] Included in the response when a content restriction is applied.
        #
        #   @param resume_point [Spotted::Models::EpisodeListResponse::Episode::ResumePoint] The user's most recent position in the episode. Set if the supplied access token

        # @see Spotted::Models::EpisodeListResponse::Episode#external_urls
        class ExternalURLs < Spotted::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Spotted::Models::EpisodeListResponse::Episode::ExternalURLs} for more details.
          #
          #   External URLs for this episode.
          #
        ...
        class Image < Spotted::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Spotted::Models::EpisodeListResponse::Episode::Image} for more details.
          #
        ...
        # The precision with which `release_date` value is known.
        #
        # @see Spotted::Models::EpisodeListResponse::Episode#release_date_precision
        ...
        # @see Spotted::Models::EpisodeListResponse::Episode#show
        class Show < Spotted::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Spotted::Models::EpisodeListResponse::Episode::Show::Copyright>]
          required :copyrights,
                   -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::EpisodeListResponse::Episode::Show::Copyright] }
          ...
          #
          #   @return [Spotted::Models::EpisodeListResponse::Episode::Show::ExternalURLs]
          required :external_urls, -> { Spotted::Models::EpisodeListResponse::Episode::Show::ExternalURLs }
          ...
          #
          #   @return [Array<Spotted::Models::EpisodeListResponse::Episode::Show::Image>]
          required :images,
                   -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::EpisodeListResponse::Episode::Show::Image] }
          ...
          #   The object type.
          #
          #   @return [Symbol, Spotted::Models::EpisodeListResponse::Episode::Show::Type]
          required :type, enum: -> { Spotted::Models::EpisodeListResponse::Episode::Show::Type }
          ...
          #   Some parameter documentations has been truncated, see
          #   {Spotted::Models::EpisodeListResponse::Episode::Show} for more details.
          #
          #   The show on which the episode belongs.
          #
          ...
          #
          #   @param copyrights [Array<Spotted::Models::EpisodeListResponse::Episode::Show::Copyright>] The copyright statements of the show.
          #
          ...
          #
          #   @param external_urls [Spotted::Models::EpisodeListResponse::Episode::Show::ExternalURLs] External URLs for this show.
          #
          ...
          #
          #   @param images [Array<Spotted::Models::EpisodeListResponse::Episode::Show::Image>] The cover art for the show in various sizes, widest first.
          #
          ...
          #
          #   @param type [Symbol, Spotted::Models::EpisodeListResponse::Episode::Show::Type] The object type.
          #
          ...
          class Copyright < Spotted::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {Spotted::Models::EpisodeListResponse::Episode::Show::Copyright} for more
            #   details.
            #
          ...
          # @see Spotted::Models::EpisodeListResponse::Episode::Show#external_urls
          class ExternalURLs < Spotted::Internal::Type::BaseModel
            # @!attribute spotify
            #   The [Spotify URL](/documentation/web-api/concepts/spotify-uris-ids) for the
            #   object.
            ...
            # @!method initialize(spotify: nil)
            #   Some parameter documentations has been truncated, see
            #   {Spotted::Models::EpisodeListResponse::Episode::Show::ExternalURLs} for more
            #   details.
            #
            #   External URLs for this show.
            #
          ...
          class Image < Spotted::Internal::Type::BaseModel
            ...
            # @!method initialize(height:, url:, width:)
            #   Some parameter documentations has been truncated, see
            #   {Spotted::Models::EpisodeListResponse::Episode::Show::Image} for more details.
            #
            #   @param height [Integer, nil] The image height in pixels.
            #
            #   @param url [String] The source URL of the image.
          ...
          # The object type.
          #
          # @see Spotted::Models::EpisodeListResponse::Episode::Show#type
          module Type
            extend Spotted::Internal::Type::Enum
        ...
        # The object type.
        #
        # @see Spotted::Models::EpisodeListResponse::Episode#type
        module Type
          extend Spotted::Internal::Type::Enum
        ...
        # @see Spotted::Models::EpisodeListResponse::Episode#restrictions
        class Restrictions < Spotted::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Spotted::Models::EpisodeListResponse::Episode::Restrictions} for more details.
          #
          #   Included in the response when a content restriction is applied.
          #
        ...
        # @see Spotted::Models::EpisodeListResponse::Episode#resume_point
        class ResumePoint < Spotted::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Spotted::Models::EpisodeListResponse::Episode::ResumePoint} for more details.
          #
          #   The user's most recent position in the episode. Set if the supplied access token
          #   is a user token and has the scope 'user-read-playback-position'.
          #
