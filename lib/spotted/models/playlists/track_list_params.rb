  ...
  module Models
    module Playlists
      ...
      class TrackListParams < Spotted::Internal::Type::BaseModel
        ...
        # @!method initialize(playlist_id:, additional_types: nil, fields: nil, limit: nil, market: nil, offset: nil, request_options: {})
        ...
        #
        #   @param limit [Integer] The maximum number of items to return. Default: 20. Minimum: 1. Maximum: 100.
        #
