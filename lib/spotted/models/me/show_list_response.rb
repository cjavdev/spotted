  ...
  module Models
    module Me
      ...
      class ShowListResponse < Spotted::Internal::Type::BaseModel
        ...
        # @!attribute items
        #
        #   @return [Array<Spotted::Models::Me::ShowListResponse::Item>]
        required :items, -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::Me::ShowListResponse::Item] }
        ...
        #
        #   @param items [Array<Spotted::Models::Me::ShowListResponse::Item>]
        #
        ...
        class Item < Spotted::Internal::Type::BaseModel
          ...
          #
          #   @return [Spotted::Models::Me::ShowListResponse::Item::Show, nil]
          optional :show, -> { Spotted::Models::Me::ShowListResponse::Item::Show }

          # @!method initialize(added_at: nil, show: nil)
          #   Some parameter documentations has been truncated, see
          #   {Spotted::Models::Me::ShowListResponse::Item} for more details.
          #
          #   @param added_at [Time] The date and time the show was saved.
          #
          #   @param show [Spotted::Models::Me::ShowListResponse::Item::Show] Information about the show.

          # @see Spotted::Models::Me::ShowListResponse::Item#show
          class Show < Spotted::Internal::Type::BaseModel
            ...
            #
            #   @return [Array<Spotted::Models::Me::ShowListResponse::Item::Show::Copyright>]
            required :copyrights,
                     -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::Me::ShowListResponse::Item::Show::Copyright] }
            ...
            #
            #   @return [Spotted::Models::Me::ShowListResponse::Item::Show::ExternalURLs]
            required :external_urls, -> { Spotted::Models::Me::ShowListResponse::Item::Show::ExternalURLs }
            ...
            #
            #   @return [Array<Spotted::Models::Me::ShowListResponse::Item::Show::Image>]
            required :images,
                     -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::Me::ShowListResponse::Item::Show::Image] }
            ...
            #   The object type.
            #
            #   @return [Symbol, Spotted::Models::Me::ShowListResponse::Item::Show::Type]
            required :type, enum: -> { Spotted::Models::Me::ShowListResponse::Item::Show::Type }
            ...
            #   Some parameter documentations has been truncated, see
            #   {Spotted::Models::Me::ShowListResponse::Item::Show} for more details.
            #
            #   Information about the show.
            #
            ...
            #
            #   @param copyrights [Array<Spotted::Models::Me::ShowListResponse::Item::Show::Copyright>] The copyright statements of the show.
            #
            ...
            #
            #   @param external_urls [Spotted::Models::Me::ShowListResponse::Item::Show::ExternalURLs] External URLs for this show.
            #
            ...
            #
            #   @param images [Array<Spotted::Models::Me::ShowListResponse::Item::Show::Image>] The cover art for the show in various sizes, widest first.
            #
            ...
            #
            #   @param type [Symbol, Spotted::Models::Me::ShowListResponse::Item::Show::Type] The object type.
            #
            ...
            class Copyright < Spotted::Internal::Type::BaseModel
              ...
              #   Some parameter documentations has been truncated, see
              #   {Spotted::Models::Me::ShowListResponse::Item::Show::Copyright} for more details.
              #
            ...
            # @see Spotted::Models::Me::ShowListResponse::Item::Show#external_urls
            class ExternalURLs < Spotted::Internal::Type::BaseModel
              ...
              #   Some parameter documentations has been truncated, see
              #   {Spotted::Models::Me::ShowListResponse::Item::Show::ExternalURLs} for more
              #   details.
              #
              #   External URLs for this show.
              #
            ...
            class Image < Spotted::Internal::Type::BaseModel
              ...
              #   Some parameter documentations has been truncated, see
              #   {Spotted::Models::Me::ShowListResponse::Item::Show::Image} for more details.
              #
            ...
            # The object type.
            #
            # @see Spotted::Models::Me::ShowListResponse::Item::Show#type
            module Type
