    ...
    module Me
      ...
      class AlbumListResponse < Spotted::Internal::Type::BaseModel
        ...
        class Album < Spotted::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Spotted::Models::Me::AlbumListResponse::Album::AlbumType]
          ...
          #
          #   @return [Symbol, Spotted::Models::Me::AlbumListResponse::Album::ReleaseDatePrecision]
          ...
          #
          #   @param album_type [Symbol, Spotted::Models::Me::AlbumListResponse::Album::AlbumType] The type of the album.
          #
          ...
          #
          #   @param release_date_precision [Symbol, Spotted::Models::Me::AlbumListResponse::Album::ReleaseDatePrecision] The precision with which `release_date` value is known.
          #
          ...
          # The type of the album.
          #
          # @see Spotted::Models::Me::AlbumListResponse::Album#album_type
          module AlbumType
          ...
          # The precision with which `release_date` value is known.
          #
          # @see Spotted::Models::Me::AlbumListResponse::Album#release_date_precision
