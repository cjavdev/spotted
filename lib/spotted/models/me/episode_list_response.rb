  ...
  module Models
    module Me
      ...
      class EpisodeListResponse < Spotted::Internal::Type::BaseModel
        ...
        # @!attribute items
        #
        #   @return [Array<Spotted::Models::Me::EpisodeListResponse::Item>]
        required :items, -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::Me::EpisodeListResponse::Item] }
        ...
        #
        #   @param items [Array<Spotted::Models::Me::EpisodeListResponse::Item>]
        #
        ...
        class Item < Spotted::Internal::Type::BaseModel
          ...
          #
          #   @return [Spotted::Models::Me::EpisodeListResponse::Item::Episode, nil]
          optional :episode, -> { Spotted::Models::Me::EpisodeListResponse::Item::Episode }

          # @!method initialize(added_at: nil, episode: nil)
          #   Some parameter documentations has been truncated, see
          #   {Spotted::Models::Me::EpisodeListResponse::Item} for more details.
          #
          #   @param added_at [Time] The date and time the episode was saved.
          #
          #   @param episode [Spotted::Models::Me::EpisodeListResponse::Item::Episode] Information about the episode.

          # @see Spotted::Models::Me::EpisodeListResponse::Item#episode
          class Episode < Spotted::Internal::Type::BaseModel
            ...
            #
            #   @return [Spotted::Models::Me::EpisodeListResponse::Item::Episode::ExternalURLs]
            required :external_urls, -> { Spotted::Models::Me::EpisodeListResponse::Item::Episode::ExternalURLs }
            ...
            #
            #   @return [Array<Spotted::Models::Me::EpisodeListResponse::Item::Episode::Image>]
            required :images,
                     -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::Me::EpisodeListResponse::Item::Episode::Image] }
            ...
            #
            #   @return [Symbol, Spotted::Models::Me::EpisodeListResponse::Item::Episode::ReleaseDatePrecision]
            required :release_date_precision,
                     enum: -> { Spotted::Models::Me::EpisodeListResponse::Item::Episode::ReleaseDatePrecision }

            # @!attribute show
            #   The show on which the episode belongs.
            #
            #   @return [Spotted::Models::Me::EpisodeListResponse::Item::Episode::Show]
            required :show, -> { Spotted::Models::Me::EpisodeListResponse::Item::Episode::Show }

            # @!attribute type
            #   The object type.
            #
            #   @return [Symbol, Spotted::Models::Me::EpisodeListResponse::Item::Episode::Type]
            required :type, enum: -> { Spotted::Models::Me::EpisodeListResponse::Item::Episode::Type }
            ...
            #
            #   @return [Spotted::Models::Me::EpisodeListResponse::Item::Episode::Restrictions, nil]
            optional :restrictions, -> { Spotted::Models::Me::EpisodeListResponse::Item::Episode::Restrictions }

            # @!attribute resume_point
            #   The user's most recent position in the episode. Set if the supplied access token
            #   is a user token and has the scope 'user-read-playback-position'.
            #
            #   @return [Spotted::Models::Me::EpisodeListResponse::Item::Episode::ResumePoint, nil]
            optional :resume_point, -> { Spotted::Models::Me::EpisodeListResponse::Item::Episode::ResumePoint }
            ...
            #   Some parameter documentations has been truncated, see
            #   {Spotted::Models::Me::EpisodeListResponse::Item::Episode} for more details.
            #
            #   Information about the episode.
            #
            ...
            #
            #   @param external_urls [Spotted::Models::Me::EpisodeListResponse::Item::Episode::ExternalURLs] External URLs for this episode.
            #
            ...
            #
            #   @param images [Array<Spotted::Models::Me::EpisodeListResponse::Item::Episode::Image>] The cover art for the episode in various sizes, widest first.
            #
            ...
            #
            #   @param release_date_precision [Symbol, Spotted::Models::Me::EpisodeListResponse::Item::Episode::ReleaseDatePrecision] The precision with which `release_date` value is known.
            #
            #   @param show [Spotted::Models::Me::EpisodeListResponse::Item::Episode::Show] The show on which the episode belongs.
            #
            #   @param type [Symbol, Spotted::Models::Me::EpisodeListResponse::Item::Episode::Type] The object type.
            #
            ...
            #
            #   @param restrictions [Spotted::Models::Me::EpisodeListResponse::Item::Episode::Restrictions] Included in the response when a content restriction is applied.
            #
            #   @param resume_point [Spotted::Models::Me::EpisodeListResponse::Item::Episode::ResumePoint] The user's most recent position in the episode. Set if the supplied access token

            # @see Spotted::Models::Me::EpisodeListResponse::Item::Episode#external_urls
            class ExternalURLs < Spotted::Internal::Type::BaseModel
              ...
              #   Some parameter documentations has been truncated, see
              #   {Spotted::Models::Me::EpisodeListResponse::Item::Episode::ExternalURLs} for more
              #   details.
              #
              #   External URLs for this episode.
              #
            ...
            class Image < Spotted::Internal::Type::BaseModel
              ...
              #   Some parameter documentations has been truncated, see
              #   {Spotted::Models::Me::EpisodeListResponse::Item::Episode::Image} for more
              #   details.
              #
            ...
            # The precision with which `release_date` value is known.
            #
            # @see Spotted::Models::Me::EpisodeListResponse::Item::Episode#release_date_precision
            ...
            # @see Spotted::Models::Me::EpisodeListResponse::Item::Episode#show
            class Show < Spotted::Internal::Type::BaseModel
              ...
              #
              #   @return [Array<Spotted::Models::Me::EpisodeListResponse::Item::Episode::Show::Copyright>]
              required :copyrights,
                       -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::Me::EpisodeListResponse::Item::Episode::Show::Copyright] }
              ...
              #
              #   @return [Spotted::Models::Me::EpisodeListResponse::Item::Episode::Show::ExternalURLs]
              required :external_urls,
                       -> { Spotted::Models::Me::EpisodeListResponse::Item::Episode::Show::ExternalURLs }
              ...
              #
              #   @return [Array<Spotted::Models::Me::EpisodeListResponse::Item::Episode::Show::Image>]
              required :images,
                       -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::Me::EpisodeListResponse::Item::Episode::Show::Image] }
              ...
              #   The object type.
              #
              #   @return [Symbol, Spotted::Models::Me::EpisodeListResponse::Item::Episode::Show::Type]
              required :type, enum: -> { Spotted::Models::Me::EpisodeListResponse::Item::Episode::Show::Type }
              ...
              #   Some parameter documentations has been truncated, see
              #   {Spotted::Models::Me::EpisodeListResponse::Item::Episode::Show} for more
              #   details.
              #
              #   The show on which the episode belongs.
              #
              ...
              #
              #   @param copyrights [Array<Spotted::Models::Me::EpisodeListResponse::Item::Episode::Show::Copyright>] The copyright statements of the show.
              #
              ...
              #
              #   @param external_urls [Spotted::Models::Me::EpisodeListResponse::Item::Episode::Show::ExternalURLs] External URLs for this show.
              #
              ...
              #
              #   @param images [Array<Spotted::Models::Me::EpisodeListResponse::Item::Episode::Show::Image>] The cover art for the show in various sizes, widest first.
              #
              ...
              #
              #   @param type [Symbol, Spotted::Models::Me::EpisodeListResponse::Item::Episode::Show::Type] The object type.
              #
              ...
              class Copyright < Spotted::Internal::Type::BaseModel
                ...
                #   Some parameter documentations has been truncated, see
                #   {Spotted::Models::Me::EpisodeListResponse::Item::Episode::Show::Copyright} for
                #   more details.
                #
              ...
              # @see Spotted::Models::Me::EpisodeListResponse::Item::Episode::Show#external_urls
              class ExternalURLs < Spotted::Internal::Type::BaseModel
                # @!attribute spotify
                #   The [Spotify URL](/documentation/web-api/concepts/spotify-uris-ids) for the
                #   object.
              ...
              class Image < Spotted::Internal::Type::BaseModel
                ...
                # @!method initialize(height:, url:, width:)
                #   Some parameter documentations has been truncated, see
                #   {Spotted::Models::Me::EpisodeListResponse::Item::Episode::Show::Image} for more
                #   details.
                #
                #   @param height [Integer, nil] The image height in pixels.
                #
              ...
              # The object type.
              #
              # @see Spotted::Models::Me::EpisodeListResponse::Item::Episode::Show#type
              module Type
                extend Spotted::Internal::Type::Enum
            ...
            # The object type.
            #
            # @see Spotted::Models::Me::EpisodeListResponse::Item::Episode#type
            module Type
              extend Spotted::Internal::Type::Enum
            ...
            # @see Spotted::Models::Me::EpisodeListResponse::Item::Episode#restrictions
            class Restrictions < Spotted::Internal::Type::BaseModel
              ...
              #   Some parameter documentations has been truncated, see
              #   {Spotted::Models::Me::EpisodeListResponse::Item::Episode::Restrictions} for more
              #   details.
              #
              #   Included in the response when a content restriction is applied.
              #
            ...
            # @see Spotted::Models::Me::EpisodeListResponse::Item::Episode#resume_point
            class ResumePoint < Spotted::Internal::Type::BaseModel
              ...
              #   Some parameter documentations has been truncated, see
              #   {Spotted::Models::Me::EpisodeListResponse::Item::Episode::ResumePoint} for more
              #   details.
              #
              #   The user's most recent position in the episode. Set if the supplied access token
              #   is a user token and has the scope 'user-read-playback-position'.
