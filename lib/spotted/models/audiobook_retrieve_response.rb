...
module Spotted
  module Models
    ...
    class AudiobookRetrieveResponse < Spotted::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Spotted::Models::AudiobookRetrieveResponse::Author>]
      required :authors,
               -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::AudiobookRetrieveResponse::Author] }
      ...
      #
      #   @return [Array<Spotted::Models::AudiobookRetrieveResponse::Copyright>]
      required :copyrights,
               -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::AudiobookRetrieveResponse::Copyright] }
      ...
      #
      #   @return [Spotted::Models::AudiobookRetrieveResponse::ExternalURLs]
      required :external_urls, -> { Spotted::Models::AudiobookRetrieveResponse::ExternalURLs }
      ...
      #
      #   @return [Array<Spotted::Models::AudiobookRetrieveResponse::Image>]
      required :images,
               -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::AudiobookRetrieveResponse::Image] }
      ...
      #
      #   @return [Array<Spotted::Models::AudiobookRetrieveResponse::Narrator>]
      required :narrators,
               -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::AudiobookRetrieveResponse::Narrator] }
      ...
      #
      #   @param authors [Array<Spotted::Models::AudiobookRetrieveResponse::Author>] The author(s) for the audiobook.
      #
      ...
      #
      #   @param copyrights [Array<Spotted::Models::AudiobookRetrieveResponse::Copyright>] The copyright statements of the audiobook.
      #
      ...
      #
      #   @param external_urls [Spotted::Models::AudiobookRetrieveResponse::ExternalURLs] External URLs for this audiobook.
      #
      ...
      #
      #   @param images [Array<Spotted::Models::AudiobookRetrieveResponse::Image>] The cover art for the audiobook in various sizes, widest first.
      #
      ...
      #
      #   @param narrators [Array<Spotted::Models::AudiobookRetrieveResponse::Narrator>] The narrator(s) for the audiobook.
      #
      ...
      class Author < Spotted::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {Spotted::Models::AudiobookRetrieveResponse::Author} for more details.
        #
      ...
      class Chapters < Spotted::Internal::Type::BaseModel
        ...
        # @!attribute items
        #
        #   @return [Array<Spotted::Models::AudiobookRetrieveResponse::Chapters::Item>]
        required :items,
                 -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::AudiobookRetrieveResponse::Chapters::Item] }
        ...
        #
        #   @param items [Array<Spotted::Models::AudiobookRetrieveResponse::Chapters::Item>]
        #
        ...
        class Item < Spotted::Internal::Type::BaseModel
          ...
          #
          #   @return [Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::ExternalURLs]
          required :external_urls, -> { Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::ExternalURLs }
          ...
          #
          #   @return [Array<Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::Image>]
          required :images,
                   -> { Spotted::Internal::Type::ArrayOf[Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::Image] }
          ...
          #
          #   @return [Symbol, Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::ReleaseDatePrecision]
          required :release_date_precision,
                   enum: -> { Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::ReleaseDatePrecision }

          # @!attribute type
          #   The object type.
          #
          #   @return [Symbol, Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::Type]
          required :type, enum: -> { Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::Type }
          ...
          #
          #   @return [Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::Restrictions, nil]
          optional :restrictions, -> { Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::Restrictions }

          # @!attribute resume_point
          #   The user's most recent position in the chapter. Set if the supplied access token
          #   is a user token and has the scope 'user-read-playback-position'.
          #
          #   @return [Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::ResumePoint, nil]
          optional :resume_point, -> { Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::ResumePoint }
          ...
          #   Some parameter documentations has been truncated, see
          #   {Spotted::Models::AudiobookRetrieveResponse::Chapters::Item} for more details.
          #
          ...
          #
          #   @param external_urls [Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::ExternalURLs] External URLs for this chapter.
          #
          ...
          #
          #   @param images [Array<Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::Image>] The cover art for the chapter in various sizes, widest first.
          #
          ...
          #
          #   @param release_date_precision [Symbol, Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::ReleaseDatePrecision] The precision with which `release_date` value is known.
          #
          #   @param type [Symbol, Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::Type] The object type.
          #
          ...
          #
          #   @param restrictions [Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::Restrictions] Included in the response when a content restriction is applied.
          #
          #   @param resume_point [Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::ResumePoint] The user's most recent position in the chapter. Set if the supplied access token

          # @see Spotted::Models::AudiobookRetrieveResponse::Chapters::Item#external_urls
          class ExternalURLs < Spotted::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::ExternalURLs} for
            #   more details.
            #
            #   External URLs for this chapter.
            #
          ...
          class Image < Spotted::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::Image} for more
            #   details.
            #
          ...
          # The precision with which `release_date` value is known.
          #
          # @see Spotted::Models::AudiobookRetrieveResponse::Chapters::Item#release_date_precision
          ...
          # The object type.
          #
          # @see Spotted::Models::AudiobookRetrieveResponse::Chapters::Item#type
          module Type
            extend Spotted::Internal::Type::Enum
          ...
          # @see Spotted::Models::AudiobookRetrieveResponse::Chapters::Item#restrictions
          class Restrictions < Spotted::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::Restrictions} for
            #   more details.
            #
            #   Included in the response when a content restriction is applied.
            #
          ...
          # @see Spotted::Models::AudiobookRetrieveResponse::Chapters::Item#resume_point
          class ResumePoint < Spotted::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::ResumePoint} for
            #   more details.
            #
            #   The user's most recent position in the chapter. Set if the supplied access token
            #   is a user token and has the scope 'user-read-playback-position'.
      ...
      class Copyright < Spotted::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {Spotted::Models::AudiobookRetrieveResponse::Copyright} for more details.
        #
      ...
      # @see Spotted::Models::AudiobookRetrieveResponse#external_urls
      class ExternalURLs < Spotted::Internal::Type::BaseModel
        # @!attribute spotify
        #   The [Spotify URL](/documentation/web-api/concepts/spotify-uris-ids) for the
        #   object.
        ...
        # @!method initialize(spotify: nil)
        #   Some parameter documentations has been truncated, see
        #   {Spotted::Models::AudiobookRetrieveResponse::ExternalURLs} for more details.
        #
        #   External URLs for this audiobook.
        #
        #   @param spotify [String] The [Spotify URL](/documentation/web-api/concepts/spotify-uris-ids) for the obje
      ...
      class Image < Spotted::Internal::Type::BaseModel
        ...
        # @!method initialize(height:, url:, width:)
        #   Some parameter documentations has been truncated, see
        #   {Spotted::Models::AudiobookRetrieveResponse::Image} for more details.
        #
        #   @param height [Integer, nil] The image height in pixels.
        #
        #   @param url [String] The source URL of the image.
      ...
      class Narrator < Spotted::Internal::Type::BaseModel
        ...
        # @!method initialize(name: nil)
        #   Some parameter documentations has been truncated, see
        #   {Spotted::Models::AudiobookRetrieveResponse::Narrator} for more details.
        #
