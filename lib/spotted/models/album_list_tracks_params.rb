...
module Spotted
  module Models
    # @see Spotted::Resources::Albums#list_tracks
    class AlbumListTracksParams < Spotted::Internal::Type::BaseModel
      ...
      # @!method initialize(id:, limit: nil, market: nil, offset: nil, request_options: {})
