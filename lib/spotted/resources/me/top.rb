  ...
  module Resources
    class Me
      class Top
        ...
        #
        # @overload list(type, limit: nil, offset: nil, time_range: nil, request_options: {})
        #
        # @param type [Symbol, Spotted::Models::Me::TopListParams::Type] The type of entity to return. Valid values: `artists` or `tracks`
        #
        ...
        #
        # @return [Spotted::Internal::CursorURLPage<Spotted::Models::ArtistObject, Spotted::Models::TrackObject>]
        #
        # @see Spotted::Models::Me::TopListParams
        def list(type, params = {})
          parsed, options = Spotted::Me::TopListParams.dump_request(params)
          @client.request(
            method: :get,
            path: ["me/top/%1$s", type],
            query: parsed,
            page: Spotted::Internal::CursorURLPage,
            model: Spotted::Models::Me::TopListResponse,
            options: options
          )
        end
