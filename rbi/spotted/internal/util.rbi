      ...
      class << self
        ...
        sig do
          params(url: T.any(URI::Generic, String)).returns(
            Spotted::Internal::Util::ParsedUri
          )
        end
        def parse_uri(url)
        end
        ...
        # @api private
        sig do
          params(parsed: Spotted::Internal::Util::ParsedUri).returns(
            URI::Generic
          )
        end
        ...
        sig do
          params(
            lhs: Spotted::Internal::Util::ParsedUri,
            rhs: Spotted::Internal::Util::ParsedUri
          ).returns(URI::Generic)
        end
      ...
      class << self
        ...
        sig do
          params(lines: T::Enumerable[String]).returns(
            T::Enumerable[Spotted::Internal::Util::ServerSentEvent]
          )
        end
      ...
      module SorbetRuntimeSupport
        ...
        class << self
          ...
          sig do
            params(
              type:
                T.any(Spotted::Internal::Util::SorbetRuntimeSupport, T.anything)
            ).returns(T.anything)
          end
