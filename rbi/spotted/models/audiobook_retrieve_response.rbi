...
module Spotted
  module Models
    class AudiobookRetrieveResponse < Spotted::Internal::Type::BaseModel
      ...
      sig do
        returns(T::Array[Spotted::Models::AudiobookRetrieveResponse::Author])
      end
      ...
      sig do
        returns(T::Array[Spotted::Models::AudiobookRetrieveResponse::Copyright])
      end
      ...
      sig { returns(Spotted::Models::AudiobookRetrieveResponse::ExternalURLs) }
      attr_reader :external_urls

      sig do
        params(
          external_urls:
            Spotted::Models::AudiobookRetrieveResponse::ExternalURLs::OrHash
        ).void
      end
      ...
      sig do
        returns(T::Array[Spotted::Models::AudiobookRetrieveResponse::Image])
      end
      ...
      sig do
        returns(T::Array[Spotted::Models::AudiobookRetrieveResponse::Narrator])
      end
      ...
      sig do
        params(
          ...
          authors:
            T::Array[
              Spotted::Models::AudiobookRetrieveResponse::Author::OrHash
            ],
          ...
          copyrights:
            T::Array[
              Spotted::Models::AudiobookRetrieveResponse::Copyright::OrHash
            ],
          description: String,
          explicit: T::Boolean,
          external_urls:
          ...
          images:
            T::Array[Spotted::Models::AudiobookRetrieveResponse::Image::OrHash],
          languages: T::Array[String],
          media_type: String,
          name: String,
          narrators:
            T::Array[
              Spotted::Models::AudiobookRetrieveResponse::Narrator::OrHash
            ],
          publisher: String,
        ...
        override.returns(
          {
            id: String,
            authors:
              T::Array[Spotted::Models::AudiobookRetrieveResponse::Author],
            available_markets: T::Array[String],
            chapters: Spotted::Models::AudiobookRetrieveResponse::Chapters,
            copyrights:
              T::Array[Spotted::Models::AudiobookRetrieveResponse::Copyright],
            description: String,
            explicit: T::Boolean,
            external_urls:
              Spotted::Models::AudiobookRetrieveResponse::ExternalURLs,
            href: String,
            html_description: String,
            images: T::Array[Spotted::Models::AudiobookRetrieveResponse::Image],
            languages: T::Array[String],
            media_type: String,
            name: String,
            narrators:
              T::Array[Spotted::Models::AudiobookRetrieveResponse::Narrator],
            publisher: String,
            total_chapters: Integer,
            type:
      ...
      class Author < Spotted::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Spotted::Models::AudiobookRetrieveResponse::Author,
              Spotted::Internal::AnyHash
            )
          end
      ...
      class Chapters < Spotted::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T::Array[Spotted::Models::AudiobookRetrieveResponse::Chapters::Item]
          )
        end
        attr_accessor :items
        ...
        sig do
          params(
            ...
            items:
              T::Array[
                Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::OrHash
              ],
            limit: Integer,
          ...
          override.returns(
            {
              ...
              items:
                T::Array[
                  Spotted::Models::AudiobookRetrieveResponse::Chapters::Item
                ],
              limit: Integer,
              next_: T.nilable(String),
              offset: Integer,
        ...
        class Item < Spotted::Internal::Type::BaseModel
          ...
          sig do
            returns(
              Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::ExternalURLs
            )
          end
          attr_reader :external_urls
          ...
          sig do
            params(
              external_urls:
                Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::ExternalURLs::OrHash
            ).void
          end
          attr_writer :external_urls
          ...
          sig do
            returns(
              T::Array[
                Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::Image
              ]
            )
          end
          attr_accessor :images
          ...
          sig do
            returns(
              Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::ReleaseDatePrecision::TaggedSymbol
            )
          end
          ...
          sig do
            returns(
              Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::Type::TaggedSymbol
            )
          end
          attr_accessor :type
          ...
          sig do
            params(
              restrictions:
                Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::Restrictions::OrHash
            ).void
          end
          ...
          sig do
            params(
              resume_point:
                Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::ResumePoint::OrHash
            ).void
          end
          ...
          sig do
            params(
              ...
              images:
                T::Array[
                  Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::Image::OrHash
                ],
              ...
              release_date_precision:
                Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::ReleaseDatePrecision::OrSymbol,
              type:
                Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::Type::OrSymbol,
              uri: String,
              available_markets: T::Array[String],
              restrictions:
                Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::Restrictions::OrHash,
          ...
          module ReleaseDatePrecision
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::ReleaseDatePrecision
                )
              end
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Spotted::Models::AudiobookRetrieveResponse::Chapters::Item::Type
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      class Copyright < Spotted::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Spotted::Models::AudiobookRetrieveResponse::Copyright,
              Spotted::Internal::AnyHash
            )
          end
      ...
      class Image < Spotted::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Spotted::Models::AudiobookRetrieveResponse::Image,
              Spotted::Internal::AnyHash
            )
          end
      ...
      class Narrator < Spotted::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Spotted::Models::AudiobookRetrieveResponse::Narrator,
              Spotted::Internal::AnyHash
            )
          end
