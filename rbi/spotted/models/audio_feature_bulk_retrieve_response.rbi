  ...
  module Models
    class AudioFeatureBulkRetrieveResponse < Spotted::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Spotted::Models::AudioFeatureBulkRetrieveResponse,
      ...
      sig do
        returns(
          T::Array[
            Spotted::Models::AudioFeatureBulkRetrieveResponse::AudioFeature
          ]
        )
      end
      ...
      sig do
        params(
          audio_features:
            T::Array[
              Spotted::Models::AudioFeatureBulkRetrieveResponse::AudioFeature::OrHash
            ]
      ...
      class AudioFeature < Spotted::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              Spotted::Models::AudioFeatureBulkRetrieveResponse::AudioFeature::Type::TaggedSymbol
            )
          )
        end
        attr_reader :type
        ...
        sig do
          params(
            type:
              Spotted::Models::AudioFeatureBulkRetrieveResponse::AudioFeature::Type::OrSymbol
          ).void
        end
        attr_writer :type
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Spotted::Models::AudioFeatureBulkRetrieveResponse::AudioFeature::Type
              )
            end
