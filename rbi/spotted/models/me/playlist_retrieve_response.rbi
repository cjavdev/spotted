    ...
    module Me
      class PlaylistRetrieveResponse < Spotted::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Spotted::Models::Me::PlaylistRetrieveResponse,
        ...
        sig do
          returns(T::Array[Spotted::Models::Me::PlaylistRetrieveResponse::Item])
        end
        attr_accessor :items
        ...
        sig do
          params(
            ...
            items:
              T::Array[
                Spotted::Models::Me::PlaylistRetrieveResponse::Item::OrHash
              ],
            limit: Integer,
          ...
          override.returns(
            {
              href: String,
              items:
                T::Array[Spotted::Models::Me::PlaylistRetrieveResponse::Item],
              limit: Integer,
              next_: T.nilable(String),
              offset: Integer,
              previous: T.nilable(String),
        ...
        class Item < Spotted::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Spotted::Models::Me::PlaylistRetrieveResponse::Item,
                Spotted::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                Spotted::Models::Me::PlaylistRetrieveResponse::Item::ExternalURLs
              )
            )
          end
          ...
          sig do
            params(
              external_urls:
                Spotted::Models::Me::PlaylistRetrieveResponse::Item::ExternalURLs::OrHash
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Spotted::Models::Me::PlaylistRetrieveResponse::Item::Image
                ]
              )
            )
          end
          ...
          sig do
            params(
              images:
                T::Array[
                  Spotted::Models::Me::PlaylistRetrieveResponse::Item::Image::OrHash
                ]
            ).void
          end
          attr_writer :images
          ...
          sig do
            returns(
              T.nilable(
                Spotted::Models::Me::PlaylistRetrieveResponse::Item::Owner
              )
            )
          end
          attr_reader :owner
          ...
          sig do
            params(
              owner:
                Spotted::Models::Me::PlaylistRetrieveResponse::Item::Owner::OrHash
            ).void
          end
          attr_writer :owner
          ...
          sig do
            returns(
              T.nilable(
                Spotted::Models::Me::PlaylistRetrieveResponse::Item::Tracks
              )
            )
          end
          attr_reader :tracks
          ...
          sig do
            params(
              tracks:
                Spotted::Models::Me::PlaylistRetrieveResponse::Item::Tracks::OrHash
            ).void
          end
          attr_writer :tracks
          ...
          class Owner < Spotted::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Spotted::Models::Me::PlaylistRetrieveResponse::Item::Owner::ExternalURLs
                )
              )
            end
            attr_reader :external_urls
            ...
            sig do
              params(
                external_urls:
                  Spotted::Models::Me::PlaylistRetrieveResponse::Item::Owner::ExternalURLs::OrHash
              ).void
            end
            attr_writer :external_urls
            ...
            sig do
              returns(
                T.nilable(
                  Spotted::Models::Me::PlaylistRetrieveResponse::Item::Owner::Type::TaggedSymbol
                )
              )
            end
            attr_reader :type
            ...
            sig do
              params(
                type:
                  Spotted::Models::Me::PlaylistRetrieveResponse::Item::Owner::Type::OrSymbol
              ).void
            end
            attr_writer :type
            ...
            module Type
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Spotted::Models::Me::PlaylistRetrieveResponse::Item::Owner::Type
                  )
                end
