  ...
  module Models
    module Me
      class AudiobookListResponse < Spotted::Internal::Type::BaseModel
        ...
        sig do
          returns(
            Spotted::Models::Me::AudiobookListResponse::Type::TaggedSymbol
          )
        end
        attr_accessor :type
        ...
        sig do
          params(
            ...
            type: Spotted::Models::Me::AudiobookListResponse::Type::OrSymbol,
            uri: String,
            edition: String
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Spotted::Models::Me::AudiobookListResponse::Type)
            end
