    ...
    module Me
      class EpisodeListResponse < Spotted::Internal::Type::BaseModel
        ...
        class Item < Spotted::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(Spotted::Models::Me::EpisodeListResponse::Item::Episode)
            )
          end
          attr_reader :episode
          ...
          sig do
            params(
              episode:
                Spotted::Models::Me::EpisodeListResponse::Item::Episode::OrHash
            ).void
          end
          attr_writer :episode
          ...
          class Episode < Spotted::Internal::Type::BaseModel
            ...
            sig do
              returns(
                Spotted::Models::Me::EpisodeListResponse::Item::Episode::ExternalURLs
              )
            end
            ...
            sig do
              params(
                external_urls:
                  Spotted::Models::Me::EpisodeListResponse::Item::Episode::ExternalURLs::OrHash
              ).void
            end
            ...
            sig do
              returns(
                T::Array[
                  Spotted::Models::Me::EpisodeListResponse::Item::Episode::Image
                ]
              )
            end
            ...
            sig do
              returns(
                Spotted::Models::Me::EpisodeListResponse::Item::Episode::ReleaseDatePrecision::TaggedSymbol
              )
            end
            ...
            sig do
              returns(
                Spotted::Models::Me::EpisodeListResponse::Item::Episode::Show
              )
            end
            attr_reader :show
            ...
            sig do
              params(
                show:
                  Spotted::Models::Me::EpisodeListResponse::Item::Episode::Show::OrHash
              ).void
            end
            attr_writer :show
            ...
            sig do
              returns(
                Spotted::Models::Me::EpisodeListResponse::Item::Episode::Type::TaggedSymbol
              )
            end
            attr_accessor :type
            ...
            sig do
              params(
                restrictions:
                  Spotted::Models::Me::EpisodeListResponse::Item::Episode::Restrictions::OrHash
              ).void
            end
            ...
            sig do
              params(
                resume_point:
                  Spotted::Models::Me::EpisodeListResponse::Item::Episode::ResumePoint::OrHash
              ).void
            end
            ...
            sig do
              params(
                ...
                images:
                  T::Array[
                    Spotted::Models::Me::EpisodeListResponse::Item::Episode::Image::OrHash
                  ],
                ...
                release_date_precision:
                  Spotted::Models::Me::EpisodeListResponse::Item::Episode::ReleaseDatePrecision::OrSymbol,
                show:
                  Spotted::Models::Me::EpisodeListResponse::Item::Episode::Show::OrHash,
                type:
                  Spotted::Models::Me::EpisodeListResponse::Item::Episode::Type::OrSymbol,
                uri: String,
                language: String,
                restrictions:
                  Spotted::Models::Me::EpisodeListResponse::Item::Episode::Restrictions::OrHash,
            ...
            module ReleaseDatePrecision
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Spotted::Models::Me::EpisodeListResponse::Item::Episode::ReleaseDatePrecision
                  )
                end
            ...
            class Show < Spotted::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  T::Array[
                    Spotted::Models::Me::EpisodeListResponse::Item::Episode::Show::Copyright
                  ]
                )
              end
              ...
              sig do
                params(
                  external_urls:
                    Spotted::Models::Me::EpisodeListResponse::Item::Episode::Show::ExternalURLs::OrHash
                ).void
              end
              attr_writer :external_urls
              ...
              sig do
                returns(
                  T::Array[
                    Spotted::Models::Me::EpisodeListResponse::Item::Episode::Show::Image
                  ]
                )
              end
              attr_accessor :images
              ...
              sig do
                returns(
                  Spotted::Models::Me::EpisodeListResponse::Item::Episode::Show::Type::TaggedSymbol
                )
              end
              attr_accessor :type
              ...
              sig do
                params(
                  ...
                  copyrights:
                    T::Array[
                      Spotted::Models::Me::EpisodeListResponse::Item::Episode::Show::Copyright::OrHash
                    ],
                  description: String,
                  explicit: T::Boolean,
                  external_urls:
                  ...
                  images:
                    T::Array[
                      Spotted::Models::Me::EpisodeListResponse::Item::Episode::Show::Image::OrHash
                    ],
                  is_externally_hosted: T::Boolean,
                  languages: T::Array[String],
                  media_type: String,
                  ...
                  type:
                    Spotted::Models::Me::EpisodeListResponse::Item::Episode::Show::Type::OrSymbol,
                  uri: String
                ).returns(T.attached_class)
              end
              def self.new(
              ...
              module Type
                ...
                TaggedSymbol =
                  T.type_alias do
                    T.all(
                      Symbol,
                      Spotted::Models::Me::EpisodeListResponse::Item::Episode::Show::Type
                    )
                  end
                OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            module Type
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Spotted::Models::Me::EpisodeListResponse::Item::Episode::Type
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
