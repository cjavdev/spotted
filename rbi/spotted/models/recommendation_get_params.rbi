...
module Spotted
  module Models
    class RecommendationGetParams < Spotted::Internal::Type::BaseModel
      ...
      sig { returns(T.nilable(String)) }
      attr_reader :seed_artists

      sig { params(seed_artists: String).void }
      attr_writer :seed_artists
      ...
      sig { returns(T.nilable(String)) }
      attr_reader :seed_genres

      sig { params(seed_genres: String).void }
      attr_writer :seed_genres
      ...
      sig { returns(T.nilable(String)) }
      attr_reader :seed_tracks

      sig { params(seed_tracks: String).void }
      attr_writer :seed_tracks
