...
module Spotted
  module Models
    class TrackListResponse < Spotted::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Spotted::Models::TrackListResponse, Spotted::Internal::AnyHash)
        end

      sig { returns(T::Array[Spotted::Models::TrackListResponse::Track]) }
      attr_accessor :tracks

      sig do
        params(
          tracks: T::Array[Spotted::Models::TrackListResponse::Track::OrHash]
      ...
      sig do
        override.returns(
          { tracks: T::Array[Spotted::Models::TrackListResponse::Track] }
        )
      end
      def to_hash
      end
      ...
      class Track < Spotted::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Spotted::Models::TrackListResponse::Track,
        ...
        sig do
          returns(T.nilable(Spotted::Models::TrackListResponse::Track::Album))
        end
        attr_reader :album

        sig do
          params(
            album: Spotted::Models::TrackListResponse::Track::Album::OrHash
          ).void
        end
        attr_writer :album
        ...
        sig do
          returns(
            T.nilable(
              T::Array[Spotted::Models::TrackListResponse::Track::Artist]
            )
          )
        end
        attr_reader :artists
        ...
        sig do
          params(
            artists:
              T::Array[
                Spotted::Models::TrackListResponse::Track::Artist::OrHash
              ]
          ).void
        end
        attr_writer :artists
        ...
        sig do
          returns(
            T.nilable(Spotted::Models::TrackListResponse::Track::ExternalIDs)
          )
        end
        ...
        sig do
          params(
            external_ids:
              Spotted::Models::TrackListResponse::Track::ExternalIDs::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(Spotted::Models::TrackListResponse::Track::ExternalURLs)
          )
        end
        ...
        sig do
          params(
            external_urls:
              Spotted::Models::TrackListResponse::Track::ExternalURLs::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(Spotted::Models::TrackListResponse::Track::Restrictions)
          )
        end
        ...
        sig do
          params(
            restrictions:
              Spotted::Models::TrackListResponse::Track::Restrictions::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Spotted::Models::TrackListResponse::Track::Type::TaggedSymbol
            )
          )
        end
        attr_reader :type
        ...
        sig do
          params(
            type: Spotted::Models::TrackListResponse::Track::Type::OrSymbol
          ).void
        end
        attr_writer :type
        ...
        sig do
          override.returns(
            {
              id: String,
              album: Spotted::Models::TrackListResponse::Track::Album,
              artists:
                T::Array[Spotted::Models::TrackListResponse::Track::Artist],
              available_markets: T::Array[String],
              disc_number: Integer,
              ...
              explicit: T::Boolean,
              external_ids:
                Spotted::Models::TrackListResponse::Track::ExternalIDs,
              external_urls:
                Spotted::Models::TrackListResponse::Track::ExternalURLs,
              href: String,
              is_local: T::Boolean,
              is_playable: T::Boolean,
              linked_from: T.anything,
              ...
              preview_url: T.nilable(String),
              restrictions:
                Spotted::Models::TrackListResponse::Track::Restrictions,
              track_number: Integer,
              type:
                Spotted::Models::TrackListResponse::Track::Type::TaggedSymbol,
              uri: String
        ...
        class Album < Spotted::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Spotted::Models::TrackListResponse::Track::Album,
                Spotted::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              Spotted::Models::TrackListResponse::Track::Album::AlbumType::TaggedSymbol
            )
          end
          ...
          sig do
            returns(
              T::Array[Spotted::Models::TrackListResponse::Track::Album::Artist]
            )
          end
          ...
          sig do
            returns(
              Spotted::Models::TrackListResponse::Track::Album::ExternalURLs
            )
          end
          attr_reader :external_urls
          ...
          sig do
            params(
              external_urls:
                Spotted::Models::TrackListResponse::Track::Album::ExternalURLs::OrHash
            ).void
          end
          attr_writer :external_urls
          ...
          sig do
            returns(
              T::Array[Spotted::Models::TrackListResponse::Track::Album::Image]
            )
          end
          ...
          sig do
            returns(
              Spotted::Models::TrackListResponse::Track::Album::ReleaseDatePrecision::TaggedSymbol
            )
          end
          ...
          sig do
            returns(
              Spotted::Models::TrackListResponse::Track::Album::Type::TaggedSymbol
            )
          end
          attr_accessor :type
          ...
          sig do
            returns(
              T.nilable(
                Spotted::Models::TrackListResponse::Track::Album::Restrictions
              )
            )
          end
          attr_reader :restrictions
          ...
          sig do
            params(
              restrictions:
                Spotted::Models::TrackListResponse::Track::Album::Restrictions::OrHash
            ).void
          end
          attr_writer :restrictions
          ...
          sig do
            params(
              id: String,
              album_type:
                Spotted::Models::TrackListResponse::Track::Album::AlbumType::OrSymbol,
              artists:
                T::Array[
                  Spotted::Models::TrackListResponse::Track::Album::Artist::OrHash
                ],
              available_markets: T::Array[String],
              external_urls:
                Spotted::Models::TrackListResponse::Track::Album::ExternalURLs::OrHash,
              ...
              images:
                T::Array[
                  Spotted::Models::TrackListResponse::Track::Album::Image::OrHash
                ],
              name: String,
              release_date: String,
              release_date_precision:
                Spotted::Models::TrackListResponse::Track::Album::ReleaseDatePrecision::OrSymbol,
              total_tracks: Integer,
              type:
                Spotted::Models::TrackListResponse::Track::Album::Type::OrSymbol,
              uri: String,
              restrictions:
                Spotted::Models::TrackListResponse::Track::Album::Restrictions::OrHash
            ).returns(T.attached_class)
            ...
            override.returns(
              {
                ...
                artists:
                  T::Array[
                    Spotted::Models::TrackListResponse::Track::Album::Artist
                  ],
                available_markets: T::Array[String],
                external_urls:
                  Spotted::Models::TrackListResponse::Track::Album::ExternalURLs,
                ...
                images:
                  T::Array[
                    Spotted::Models::TrackListResponse::Track::Album::Image
                  ],
                name: String,
                release_date: String,
                release_date_precision:
          ...
          module AlbumType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Spotted::Models::TrackListResponse::Track::Album::AlbumType
                )
              end
          ...
          class Artist < Spotted::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Spotted::Models::TrackListResponse::Track::Album::Artist::ExternalURLs
                )
              )
            end
            attr_reader :external_urls
            ...
            sig do
              params(
                external_urls:
                  Spotted::Models::TrackListResponse::Track::Album::Artist::ExternalURLs::OrHash
              ).void
            end
            attr_writer :external_urls
            ...
            sig do
              returns(
                T.nilable(
                  Spotted::Models::TrackListResponse::Track::Album::Artist::Type::TaggedSymbol
                )
              )
            end
            attr_reader :type
            ...
            sig do
              params(
                type:
                  Spotted::Models::TrackListResponse::Track::Album::Artist::Type::OrSymbol
              ).void
            end
            attr_writer :type
            ...
            module Type
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Spotted::Models::TrackListResponse::Track::Album::Artist::Type
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          module ReleaseDatePrecision
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Spotted::Models::TrackListResponse::Track::Album::ReleaseDatePrecision
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Spotted::Models::TrackListResponse::Track::Album::Type
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          class Restrictions < Spotted::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Spotted::Models::TrackListResponse::Track::Album::Restrictions::Reason::TaggedSymbol
                )
              )
            end
            attr_reader :reason
            ...
            sig do
              params(
                reason:
                  Spotted::Models::TrackListResponse::Track::Album::Restrictions::Reason::OrSymbol
              ).void
            end
            attr_writer :reason
            ...
            module Reason
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Spotted::Models::TrackListResponse::Track::Album::Restrictions::Reason
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class Artist < Spotted::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Spotted::Models::TrackListResponse::Track::Artist,
                Spotted::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                Spotted::Models::TrackListResponse::Track::Artist::ExternalURLs
              )
            )
          end
          attr_reader :external_urls
          ...
          sig do
            params(
              external_urls:
                Spotted::Models::TrackListResponse::Track::Artist::ExternalURLs::OrHash
            ).void
          end
          attr_writer :external_urls
          ...
          sig do
            returns(
              T.nilable(
                Spotted::Models::TrackListResponse::Track::Artist::Type::TaggedSymbol
              )
            )
          end
          attr_reader :type
          ...
          sig do
            params(
              type:
                Spotted::Models::TrackListResponse::Track::Artist::Type::OrSymbol
            ).void
          end
          attr_writer :type
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Spotted::Models::TrackListResponse::Track::Artist::Type
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Spotted::Models::TrackListResponse::Track::Type)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
