  ...
  module Models
    class ArtistListRelatedArtistsResponse < Spotted::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Spotted::Models::ArtistListRelatedArtistsResponse,
      ...
      sig do
        returns(
          T::Array[Spotted::Models::ArtistListRelatedArtistsResponse::Artist]
        )
      end
      ...
      sig do
        params(
          artists:
            T::Array[
              Spotted::Models::ArtistListRelatedArtistsResponse::Artist::OrHash
            ]
        ...
        override.returns(
          {
            artists:
              T::Array[
                Spotted::Models::ArtistListRelatedArtistsResponse::Artist
              ]
          }
        )
      end
      ...
      class Artist < Spotted::Internal::Type::BaseModel
        ...
        sig do
          params(
            external_urls:
              Spotted::Models::ArtistListRelatedArtistsResponse::Artist::ExternalURLs::OrHash
          ).void
        end
        ...
        sig do
          params(
            followers:
              Spotted::Models::ArtistListRelatedArtistsResponse::Artist::Followers::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Spotted::Models::ArtistListRelatedArtistsResponse::Artist::Image
              ]
            )
          )
        end
        ...
        sig do
          params(
            images:
              T::Array[
                Spotted::Models::ArtistListRelatedArtistsResponse::Artist::Image::OrHash
              ]
          ).void
        end
        attr_writer :images
        ...
        sig do
          returns(
            T.nilable(
              Spotted::Models::ArtistListRelatedArtistsResponse::Artist::Type::TaggedSymbol
            )
          )
        end
        attr_reader :type
        ...
        sig do
          params(
            type:
              Spotted::Models::ArtistListRelatedArtistsResponse::Artist::Type::OrSymbol
          ).void
        end
        attr_writer :type
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Spotted::Models::ArtistListRelatedArtistsResponse::Artist::Type
              )
            end
