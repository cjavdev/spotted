  ...
  module Models
    class ChapterBulkRetrieveResponse < Spotted::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Spotted::Models::ChapterBulkRetrieveResponse,
            Spotted::Internal::AnyHash
          )
        end

      sig do
        returns(T::Array[Spotted::Models::ChapterBulkRetrieveResponse::Chapter])
      end
      ...
      sig do
        params(
          chapters:
            T::Array[
              Spotted::Models::ChapterBulkRetrieveResponse::Chapter::OrHash
            ]
      ...
      sig do
        override.returns(
          {
            chapters:
              T::Array[Spotted::Models::ChapterBulkRetrieveResponse::Chapter]
          }
        )
      end
      def to_hash
        ...
        module ReleaseDatePrecision
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Spotted::Models::ChapterBulkRetrieveResponse::Chapter::ReleaseDatePrecision
              )
            end
