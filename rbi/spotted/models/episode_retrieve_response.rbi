  ...
  module Models
    class EpisodeRetrieveResponse < Spotted::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Spotted::Models::EpisodeRetrieveResponse,
      ...
      sig { returns(Spotted::Models::EpisodeRetrieveResponse::ExternalURLs) }
      attr_reader :external_urls

      sig do
        params(
          external_urls:
            Spotted::Models::EpisodeRetrieveResponse::ExternalURLs::OrHash
        ).void
      end
      ...
      sig { returns(T::Array[Spotted::Models::EpisodeRetrieveResponse::Image]) }
      ...
      sig do
        returns(
          Spotted::Models::EpisodeRetrieveResponse::ReleaseDatePrecision::TaggedSymbol
        )
      end
      attr_accessor :release_date_precision

      # The show on which the episode belongs.
      sig { returns(Spotted::Models::EpisodeRetrieveResponse::Show) }
      attr_reader :show

      sig do
        params(
          show: Spotted::Models::EpisodeRetrieveResponse::Show::OrHash
        ).void
      end
      attr_writer :show
      ...
      # The object type.
      sig do
        returns(Spotted::Models::EpisodeRetrieveResponse::Type::TaggedSymbol)
      end
      attr_accessor :type
      ...
      sig do
        returns(
          T.nilable(Spotted::Models::EpisodeRetrieveResponse::Restrictions)
        )
      end
      ...
      sig do
        params(
          restrictions:
            Spotted::Models::EpisodeRetrieveResponse::Restrictions::OrHash
        ).void
      end
      ...
      sig do
        returns(
          T.nilable(Spotted::Models::EpisodeRetrieveResponse::ResumePoint)
        )
      end
      ...
      sig do
        params(
          resume_point:
            Spotted::Models::EpisodeRetrieveResponse::ResumePoint::OrHash
        ).void
      end
      ...
      sig do
        params(
          ...
          images:
            T::Array[Spotted::Models::EpisodeRetrieveResponse::Image::OrHash],
          ...
          release_date_precision:
            Spotted::Models::EpisodeRetrieveResponse::ReleaseDatePrecision::OrSymbol,
          show: Spotted::Models::EpisodeRetrieveResponse::Show::OrHash,
          type: Spotted::Models::EpisodeRetrieveResponse::Type::OrSymbol,
          uri: String,
          language: String,
          restrictions:
            Spotted::Models::EpisodeRetrieveResponse::Restrictions::OrHash,
        ...
        override.returns(
          {
            ...
            explicit: T::Boolean,
            external_urls:
              Spotted::Models::EpisodeRetrieveResponse::ExternalURLs,
            href: String,
            html_description: String,
            images: T::Array[Spotted::Models::EpisodeRetrieveResponse::Image],
            is_externally_hosted: T::Boolean,
            is_playable: T::Boolean,
            languages: T::Array[String],
            name: String,
            ...
            type: Spotted::Models::EpisodeRetrieveResponse::Type::TaggedSymbol,
            uri: String,
            language: String,
            restrictions:
      ...
      class Image < Spotted::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Spotted::Models::EpisodeRetrieveResponse::Image,
              Spotted::Internal::AnyHash
            )
          end
      ...
      module ReleaseDatePrecision
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Spotted::Models::EpisodeRetrieveResponse::ReleaseDatePrecision
            )
          end
      ...
      class Show < Spotted::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Spotted::Models::EpisodeRetrieveResponse::Show,
              Spotted::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T::Array[Spotted::Models::EpisodeRetrieveResponse::Show::Copyright]
          )
        end
        ...
        sig do
          returns(Spotted::Models::EpisodeRetrieveResponse::Show::ExternalURLs)
        end
        attr_reader :external_urls
        ...
        sig do
          params(
            external_urls:
              Spotted::Models::EpisodeRetrieveResponse::Show::ExternalURLs::OrHash
          ).void
        end
        attr_writer :external_urls
        ...
        sig do
          returns(
            T::Array[Spotted::Models::EpisodeRetrieveResponse::Show::Image]
          )
        end
        attr_accessor :images
        ...
        sig do
          returns(
            Spotted::Models::EpisodeRetrieveResponse::Show::Type::TaggedSymbol
          )
        end
        attr_accessor :type
        ...
        sig do
          params(
            ...
            copyrights:
              T::Array[
                Spotted::Models::EpisodeRetrieveResponse::Show::Copyright::OrHash
              ],
            description: String,
            explicit: T::Boolean,
            external_urls:
            ...
            images:
              T::Array[
                Spotted::Models::EpisodeRetrieveResponse::Show::Image::OrHash
              ],
            is_externally_hosted: T::Boolean,
            languages: T::Array[String],
            media_type: String,
            ...
            type:
              Spotted::Models::EpisodeRetrieveResponse::Show::Type::OrSymbol,
            uri: String
          ).returns(T.attached_class)
        end
        def self.new(
          ...
          override.returns(
            {
              ...
              copyrights:
                T::Array[
                  Spotted::Models::EpisodeRetrieveResponse::Show::Copyright
                ],
              description: String,
              explicit: T::Boolean,
              external_urls:
                Spotted::Models::EpisodeRetrieveResponse::Show::ExternalURLs,
              href: String,
              html_description: String,
              images:
                T::Array[Spotted::Models::EpisodeRetrieveResponse::Show::Image],
        ...
        class Image < Spotted::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Spotted::Models::EpisodeRetrieveResponse::Show::Image,
                Spotted::Internal::AnyHash
              )
            end
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Spotted::Models::EpisodeRetrieveResponse::Show::Type
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Spotted::Models::EpisodeRetrieveResponse::Type)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        EPISODE =
          T.let(
            :episode,
            Spotted::Models::EpisodeRetrieveResponse::Type::TaggedSymbol
          )
