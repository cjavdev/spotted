  ...
  module Models
    class TrackRetrieveResponse < Spotted::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Spotted::Models::TrackRetrieveResponse,
      ...
      sig { returns(T.nilable(Spotted::Models::TrackRetrieveResponse::Album)) }
      attr_reader :album

      sig do
        params(
          album: Spotted::Models::TrackRetrieveResponse::Album::OrHash
        ).void
      end
      attr_writer :album
      ...
      sig do
        returns(
          T.nilable(T::Array[Spotted::Models::TrackRetrieveResponse::Artist])
        )
      end
      attr_reader :artists
      ...
      sig do
        params(
          artists:
            T::Array[Spotted::Models::TrackRetrieveResponse::Artist::OrHash]
        ).void
      end
      attr_writer :artists
      ...
      sig do
        returns(T.nilable(Spotted::Models::TrackRetrieveResponse::ExternalIDs))
      end
      ...
      sig do
        params(
          external_ids:
            Spotted::Models::TrackRetrieveResponse::ExternalIDs::OrHash
        ).void
      end
      ...
      sig do
        returns(T.nilable(Spotted::Models::TrackRetrieveResponse::ExternalURLs))
      end
      ...
      sig do
        params(
          external_urls:
            Spotted::Models::TrackRetrieveResponse::ExternalURLs::OrHash
        ).void
      end
      ...
      sig do
        returns(T.nilable(Spotted::Models::TrackRetrieveResponse::Restrictions))
      end
      ...
      sig do
        params(
          restrictions:
            Spotted::Models::TrackRetrieveResponse::Restrictions::OrHash
        ).void
      end
      ...
      sig do
        returns(
          T.nilable(Spotted::Models::TrackRetrieveResponse::Type::TaggedSymbol)
        )
      end
      attr_reader :type
      ...
      sig do
        params(
          type: Spotted::Models::TrackRetrieveResponse::Type::OrSymbol
        ).void
      end
      attr_writer :type
        ...
        override.returns(
          {
            ...
            artists: T::Array[Spotted::Models::TrackRetrieveResponse::Artist],
            available_markets: T::Array[String],
            disc_number: Integer,
            duration_ms: Integer,
            explicit: T::Boolean,
            ...
            track_number: Integer,
            type: Spotted::Models::TrackRetrieveResponse::Type::TaggedSymbol,
            uri: String
          }
        )
      end
      ...
      class Album < Spotted::Internal::Type::BaseModel
        ...
        sig do
          returns(
            Spotted::Models::TrackRetrieveResponse::Album::AlbumType::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            T::Array[Spotted::Models::TrackRetrieveResponse::Album::Artist]
          )
        end
        ...
        sig do
          returns(Spotted::Models::TrackRetrieveResponse::Album::ExternalURLs)
        end
        attr_reader :external_urls
        ...
        sig do
          params(
            external_urls:
              Spotted::Models::TrackRetrieveResponse::Album::ExternalURLs::OrHash
          ).void
        end
        attr_writer :external_urls
        ...
        sig do
          returns(
            T::Array[Spotted::Models::TrackRetrieveResponse::Album::Image]
          )
        end
        ...
        sig do
          returns(
            Spotted::Models::TrackRetrieveResponse::Album::ReleaseDatePrecision::TaggedSymbol
          )
        end
        ...
        sig do
          returns(
            Spotted::Models::TrackRetrieveResponse::Album::Type::TaggedSymbol
          )
        end
        attr_accessor :type
        ...
        sig do
          params(
            restrictions:
              Spotted::Models::TrackRetrieveResponse::Album::Restrictions::OrHash
          ).void
        end
        attr_writer :restrictions
        ...
        sig do
          params(
            id: String,
            album_type:
              Spotted::Models::TrackRetrieveResponse::Album::AlbumType::OrSymbol,
            artists:
              T::Array[
                Spotted::Models::TrackRetrieveResponse::Album::Artist::OrHash
              ],
            available_markets: T::Array[String],
            external_urls:
              Spotted::Models::TrackRetrieveResponse::Album::ExternalURLs::OrHash,
            ...
            images:
              T::Array[
                Spotted::Models::TrackRetrieveResponse::Album::Image::OrHash
              ],
            name: String,
            release_date: String,
            release_date_precision:
              Spotted::Models::TrackRetrieveResponse::Album::ReleaseDatePrecision::OrSymbol,
            total_tracks: Integer,
            type: Spotted::Models::TrackRetrieveResponse::Album::Type::OrSymbol,
            uri: String,
            restrictions:
              Spotted::Models::TrackRetrieveResponse::Album::Restrictions::OrHash
          ).returns(T.attached_class)
          ...
          override.returns(
            {
              ...
              available_markets: T::Array[String],
              external_urls:
                Spotted::Models::TrackRetrieveResponse::Album::ExternalURLs,
              href: String,
              images:
                T::Array[Spotted::Models::TrackRetrieveResponse::Album::Image],
              name: String,
        ...
        module AlbumType
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Spotted::Models::TrackRetrieveResponse::Album::AlbumType
              )
            end
        ...
        class Artist < Spotted::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Spotted::Models::TrackRetrieveResponse::Album::Artist,
                Spotted::Internal::AnyHash
              )
            end
          ...
          sig do
            params(
              external_urls:
                Spotted::Models::TrackRetrieveResponse::Album::Artist::ExternalURLs::OrHash
            ).void
          end
          attr_writer :external_urls
          ...
          sig do
            returns(
              T.nilable(
                Spotted::Models::TrackRetrieveResponse::Album::Artist::Type::TaggedSymbol
              )
            )
          end
          attr_reader :type
          ...
          sig do
            params(
              type:
                Spotted::Models::TrackRetrieveResponse::Album::Artist::Type::OrSymbol
            ).void
          end
          attr_writer :type
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Spotted::Models::TrackRetrieveResponse::Album::Artist::Type
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class Image < Spotted::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Spotted::Models::TrackRetrieveResponse::Album::Image,
                Spotted::Internal::AnyHash
              )
            end
        ...
        module ReleaseDatePrecision
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Spotted::Models::TrackRetrieveResponse::Album::ReleaseDatePrecision
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Spotted::Models::TrackRetrieveResponse::Album::Type)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        class Restrictions < Spotted::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Spotted::Models::TrackRetrieveResponse::Album::Restrictions::Reason::TaggedSymbol
              )
            )
          end
          attr_reader :reason
          ...
          sig do
            params(
              reason:
                Spotted::Models::TrackRetrieveResponse::Album::Restrictions::Reason::OrSymbol
            ).void
          end
          attr_writer :reason
      ...
      class Artist < Spotted::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Spotted::Models::TrackRetrieveResponse::Artist,
              Spotted::Internal::AnyHash
            )
          end
        ...
        sig do
          params(
            external_urls:
              Spotted::Models::TrackRetrieveResponse::Artist::ExternalURLs::OrHash
          ).void
        end
        attr_writer :external_urls
        ...
        sig do
          returns(
            T.nilable(
              Spotted::Models::TrackRetrieveResponse::Artist::Type::TaggedSymbol
            )
          )
        end
        attr_reader :type
        ...
        sig do
          params(
            type: Spotted::Models::TrackRetrieveResponse::Artist::Type::OrSymbol
          ).void
        end
        attr_writer :type
        ...
        sig do
          params(
            ...
            name: String,
            type:
              Spotted::Models::TrackRetrieveResponse::Artist::Type::OrSymbol,
            uri: String
          ).returns(T.attached_class)
        end
        def self.new(
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Spotted::Models::TrackRetrieveResponse::Artist::Type
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Spotted::Models::TrackRetrieveResponse::Type)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        TRACK =
          T.let(
            :track,
            Spotted::Models::TrackRetrieveResponse::Type::TaggedSymbol
          )

        sig do
          override.returns(
            T::Array[Spotted::Models::TrackRetrieveResponse::Type::TaggedSymbol]
          )
        end
        def self.values
        end
