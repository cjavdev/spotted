  ...
  module Models
    class ChapterListResponse < Spotted::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Spotted::Models::ChapterListResponse,
            Spotted::Internal::AnyHash
          )
        end

      sig { returns(T::Array[Spotted::Models::ChapterListResponse::Chapter]) }
      attr_accessor :chapters

      sig do
        params(
          chapters:
            T::Array[Spotted::Models::ChapterListResponse::Chapter::OrHash]
        ).returns(T.attached_class)
      end
      def self.new(chapters:)
      end

      sig do
        override.returns(
          { chapters: T::Array[Spotted::Models::ChapterListResponse::Chapter] }
        )
      end
      def to_hash
      end
      ...
      class Chapter < Spotted::Internal::Type::BaseModel
        ...
        sig do
          returns(
            Spotted::Models::ChapterListResponse::Chapter::ReleaseDatePrecision::TaggedSymbol
          )
        end
        ...
        sig do
          params(
            ...
            release_date_precision:
              Spotted::Models::ChapterListResponse::Chapter::ReleaseDatePrecision::OrSymbol,
        ...
        module ReleaseDatePrecision
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Spotted::Models::ChapterListResponse::Chapter::ReleaseDatePrecision
              )
            end
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Spotted::Models::ChapterListResponse::Chapter::Type)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
