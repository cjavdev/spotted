...
module Spotted
  module Models
    class SimplifiedChapterObject < Spotted::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Spotted::SimplifiedChapterObject, Spotted::Internal::AnyHash)
        end
      ...
      # The object type.
      sig { returns(Spotted::SimplifiedChapterObject::Type::TaggedSymbol) }
      attr_accessor :type
        ...
        override.returns(
          {
            ...
            release_date_precision:
              Spotted::SimplifiedChapterObject::ReleaseDatePrecision::TaggedSymbol,
            type: Spotted::SimplifiedChapterObject::Type::TaggedSymbol,
            uri: String,
            available_markets: T::Array[String],
      ...
      module ReleaseDatePrecision
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              Spotted::SimplifiedChapterObject::ReleaseDatePrecision
            )
          end
