    ...
    module Users
      class PlaylistListResponse < Spotted::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Spotted::Models::Users::PlaylistListResponse,
        ...
        sig do
          returns(T::Array[Spotted::Models::Users::PlaylistListResponse::Item])
        end
        attr_accessor :items
        ...
        sig do
          params(
            ...
            items:
              T::Array[
                Spotted::Models::Users::PlaylistListResponse::Item::OrHash
              ],
            limit: Integer,
          ...
          override.returns(
            {
              href: String,
              items:
                T::Array[Spotted::Models::Users::PlaylistListResponse::Item],
              limit: Integer,
              next_: T.nilable(String),
              offset: Integer,
              previous: T.nilable(String),
        ...
        class Item < Spotted::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Spotted::Models::Users::PlaylistListResponse::Item,
                Spotted::Internal::AnyHash
              )
            end
          ...
          sig do
            params(
              external_urls:
                Spotted::Models::Users::PlaylistListResponse::Item::ExternalURLs::OrHash
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Spotted::Models::Users::PlaylistListResponse::Item::Image
                ]
              )
            )
          end
          ...
          sig do
            params(
              images:
                T::Array[
                  Spotted::Models::Users::PlaylistListResponse::Item::Image::OrHash
                ]
            ).void
          end
          attr_writer :images
          ...
          sig do
            params(
              owner:
                Spotted::Models::Users::PlaylistListResponse::Item::Owner::OrHash
            ).void
          end
          attr_writer :owner
          ...
          sig do
            params(
              tracks:
                Spotted::Models::Users::PlaylistListResponse::Item::Tracks::OrHash
            ).void
          end
          attr_writer :tracks
          ...
          class Owner < Spotted::Internal::Type::BaseModel
            ...
            sig do
              params(
                external_urls:
                  Spotted::Models::Users::PlaylistListResponse::Item::Owner::ExternalURLs::OrHash
              ).void
            end
            attr_writer :external_urls
            ...
            sig do
              returns(
                T.nilable(
                  Spotted::Models::Users::PlaylistListResponse::Item::Owner::Type::TaggedSymbol
                )
              )
            end
            attr_reader :type
            ...
            sig do
              params(
                type:
                  Spotted::Models::Users::PlaylistListResponse::Item::Owner::Type::OrSymbol
              ).void
            end
            attr_writer :type
            ...
            module Type
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    Spotted::Models::Users::PlaylistListResponse::Item::Owner::Type
                  )
                end
